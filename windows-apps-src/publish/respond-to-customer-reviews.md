...
ms.locfileid: "4051904"
---
# <a name="respond-to-customer-reviews"></a>Reagieren auf Kundenrezensionen


Sie können auf Rezensionen Ihrer App auf, um reagieren, dass Kunden wissen, dass Sie ihr Feedback ernst. Wenn Sie auf Kritiken antworten, können Sie Kunden über neue Features oder behobene Schwachstellen informieren, die in Bezug zu ihren Kommentaren stehen, oder Sie erhalten detaillierteres Feedback mit Verbesserungsvorschlägen für Ihre App. Ihre Antworten werden im Microsoft Store für alle Windows 10-Kunden angezeigt. Sie können auch auswählen, um Ihre Antwort per e-Mail an dem Kunden zu senden, (Wenn sie noch nicht Option deaktiviert, und ein Gerät mit Windows 10, Version 1803 oder höher).
...
Standardmäßig wird Ihre Antwort im Store, direkt unter der ursprüngliche Rezension für Kunden veröffentlicht. Diese Antworten werden allen Kunden, die den Store auf einem Windows 10-Gerät anzeigen. Wenn der Kunde, der der Rezension verwendet ein Gerät mit Windows 10, Version 1803 oder höher, und sie noch nicht den Empfang von Antworten e-Mail entschieden, wird eine Kopie der Ihre Antwort auch auf diesen Kunden per e-Mail gesendet.  Sie müssen eine gültige e-Mail-Adresse angeben, um Ihre Antwort übermitteln, die wir in der e-Mail an den Kunden enthalten soll. Sie können dann diese e-Mail-Adresse, Sie direkt kontaktieren.

Wenn Sie nicht möchten, dass Ihre Antwort im Store angezeigt werden, und stattdessen nur per e-Mail an den Kunden antworten möchten, deaktivieren Sie das **Veröffentlichen Sie diese Antwort** . Beachten Sie, dass es nicht möglich ist, Deaktivieren dieses Kontrollkästchen, wenn der Kunde den Empfang von Antworten e-Mail entschieden hat bzw. Wenn sie ein Gerät verwenden, die nicht Windows 10, Version 1803 oder höher ausgeführt wird.
...
> [!IMPORTANT]
> Sie sind nicht in der Lage, ändern die Antworten, die Sie an den Store bereitstellen (es sei denn, der Kunde seine ursprüngliche Rezension), daher sollten Sie Ihre Antwort sorgfältig überprüfen. Wenn ein Kunde seine ursprüngliche Rezension überarbeitet, wird Ihre Antwort von der app Store-Eintragsseite entfernt. Sie haben dann die Möglichkeit, eine neue Antwort zur überarbeiteten Rezension zu senden, indem Sie auswählen, **Aktualisieren Sie Ihre Antwort**.
