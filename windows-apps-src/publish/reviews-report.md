...
ms.locfileid: "8943861"
---
# <a name="reviews-report"></a>Bericht „Rezensionen“


Der Bericht **"Rezensionen"** im [Partner Center](https://partner.microsoft.com/dashboard) gibt Aufschluss über die Rezensionen (Kommentare), die Kunden beim Bewerten eingegeben haben Ihre app im Store.

Sie können diese Daten im Partner Center oder [den Bericht herunterladen](download-analytic-reports.md) offline anzeigen anzeigen. Sie können diese Daten auch programmgesteuert abrufen, mithilfe der [app-Rezensionen get](../monetize/get-app-reviews.md) -Methode in der [Microsoft Store-Analyse-REST-API](../monetize/access-analytics-data-using-windows-store-services.md).
...
- **Überprüfen Sie Inhalte**: die Standardeinstellung ist **Bewertungen mit rezensionsinhalt**, was bedeutet, dass nur Bewertungen mit Rezension Inhalt angezeigt werden. Sie können auswählen, **Alle** , um alle Bewertungen angezeigt, auch derjenigen, die keinen Text schriftliche Rezension enthalten. Beachten Sie, dass das Diagramm **eine Übersicht über** alle Rezensionen, unabhängig von der Auswahl immer angezeigt wird.
...
-   **Kategoriename**: Der Standardfilter ist **Immer**. Sie können eine bestimmte [Interne Kategorie](#review-insight-categories) auswählen, um nur Rezensionen anzuzeigen, die wir dieser Kategorie zugeordnet haben. 
...
Das Diagramm **eine Übersicht über** erscheint am Anfang dieser Bericht so, dass Sie einen kurzen Überblick über die folgenden können: 
...
Beachten Sie, dass dieses Diagramm immer alle Rezensionen enthält, auch wenn Sie in den Seitenfilter **Rezension** **Bewertungen mit Inhalt zu überprüfen ausgewählt** .
...
-   Der Name des Verfassers, wie sie wird im Microsoft Store.
-   Das Land/die Region des Verfassers.
-   Die Paketversion der App, die auf dem Kundengerät installiert war, als die Rezension geschrieben wurde. (Diese Informationen steht nicht für Rezensionen von Kunden mit Windows8.1 übermittelt oder online gesendet.)
-   Die Betriebssystemversion des Geräts, das der Kunde beim Hinterlassen der Rezension verwendet hat.
-   Der Name des Geräts, das der Kunde beim Hinterlassen der Rezension verwendet hat. (Diese Informationen steht nicht für Rezensionen von Kunden mit Windows8.1 übermittelt oder online gesendet.)
...
Im Suchfeld können auch um für bestimmte Wörter oder Wortgruppen Rezensionen zu Ihrer app zu suchen. Beachten Sie, dass nur die ursprüngliche überprüfen Sie vom Kunden von Text wird durchsucht, auch wenn die Überprüfung in einer anderen Sprache geschrieben wurde. Übersetzte Rezension Text wird nicht durchsucht.
...
Wie bereits erwähnt, beim Durchsuchen von Rezensionen nur auf der ursprüngliche links vom Kunden Text wird durchsucht (und keine übersetzten Text), auch wenn das **Rezensionen übersetzen** Kontrollkästchen aktiviert ist.


## <a name="responding-to-customer-reviews"></a>Reagieren auf Kundenrezensionen

Sie können [Partner Center](https://partner.microsoft.com/dashboard) oder die [Microsoft Store-Rezensionen-API](../monetize/submit-responses-to-app-reviews.md) zum Senden von Antworten auf zahlreiche kundenrezensionen verwenden. Weitere Informationen finden Sie unter [Reagieren auf Kundenrezensionen](respond-to-customer-reviews.md).
