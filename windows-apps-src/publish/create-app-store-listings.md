...
Die Felder in diesem Abschnitt sind alle optional. Die App-Funktionen und Systemanforderungen können jedoch verwendet werden, um Kunden mehr Informationen zur Funktionsweise Ihrer App und zu den Voraussetzungen für eine optimale Nutzung anzuzeigen. Andere Optionen unterstützen eine optimale Erfahrung für Ihr Produkt in den verschiedenen Szenarien. Überprüfen Sie die Informationen unten, um zu bestimmen, ob die Bereitstellung dieser Informationen für Ihre Übermittlung sinnvoll ist.
...
Der **kurze Titel** ist auf 50 Zeichen beschränkt.
...
Wird nur für Spiele verwendet. Diese Beschreibung wird im Abschnitt der Informationen im Spiele-Hub auf Xbox One angezeigt und gibt weitere Informationen über Ihr Spiel an.
