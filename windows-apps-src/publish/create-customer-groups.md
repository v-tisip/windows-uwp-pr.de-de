...
Zum Anzeigen und Erstellen von Kundengruppen, erweitern Sie im linken Navigationsmenü des [Partner Centers](https://partner.microsoft.com/dashboard) **einbeziehen** , und wählen Sie dann **Kundengruppen**.
