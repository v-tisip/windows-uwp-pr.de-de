...
1.  Wählen Sie über das [Windows Dev Center-Dashboard](https://partner.microsoft.com/dashboard)das Zahnradsymbol (in der Nähe der oberen rechten Ecke des Dashboards), und wählen Sie dann **kontoeinstellungen**. Wählen Sie im Menü " **Einstellungen** " **Mandanten**.
