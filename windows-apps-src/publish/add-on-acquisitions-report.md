...
Wie viele Add-ons finden Sie, zusammen mit demografische verkaufte das **Add-on Übernahmen** des Berichts im Windows-Entwicklungscenter Dashboard können und Plattform Details und zeigt Konvertierung Info für Kunden mit Windows 10 (einschließlich Xbox). Sie können auch für die letzte Periode oder 70 zwei Stunden nahezu in Echtzeit Erwerb Daten anzeigen.
