...
4. Verwenden Sie auf der nächsten Seite das Dropdownmenü, um entweder **Einzelne App** oder **Mehrere Apps** auszuwählen, für die Sie eine Benachrichtigung generieren möchten. Wählen Sie die App oder die Apps aus (deren Konfiguration für den Erhalt von Benachrichtigungen mithilfe des Microsoft Store Services SDK konfiguriert ist).
