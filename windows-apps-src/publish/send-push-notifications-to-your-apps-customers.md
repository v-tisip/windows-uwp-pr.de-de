...
1. **Registrieren Sie Ihre App für den Empfang von Pushbenachrichtigungen.** Fügen Sie hierzu Ihrer App einen Verweis auf das Microsoft Store Services SDK hinzu, und ergänzen Sie anschließend einige wenige Codezeilen, mit denen ein Benachrichtigungskanal zwischen dem Dev Center und Ihrer App registriert wird. Über diesen Kanal übermitteln wir Ihre Pushbenachrichtigungen an Ihre Kunden. Details hierzu finden Sie unter [Konfigurieren Ihrer App zum Empfangen von Dev Center-Pushbenachrichtigungen](../monetize/configure-your-app-to-receive-dev-center-notifications.md).
...
- [Übersicht über Windows-Pushbenachrichtigungsdienst (Windows Push Notification Service, WNS) (Windows-Runtime-Apps)](https://msdn.microsoft.com/library/windows/apps/hh913756.aspx)
