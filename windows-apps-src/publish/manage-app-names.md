...
> [!TIP]
> Jede app, die in Ihrem Dashboard mit den Vornamen, die Sie für sie reserviert angezeigt werden. Wenn Sie die oben beschriebenen Schritte zum Benennen Sie einer app befolgt haben, und Sie es in Ihrem Dashboard mit dem neuen Namen angezeigt werden möchten, müssen Sie der ursprüngliche Name löschen, (durch Klicken auf " **Löschen** " auf der Seite " **Verwalten von app-Namen** "). 
