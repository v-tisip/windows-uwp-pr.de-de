...
Wenn Ihr Konto über [globale Administratorberechtigungen](http://go.microsoft.com/fwlink/p/?LinkId=746654) verfügt, werden zusätzliche Möglichkeiten angezeigt, um Benutzer hinzuzufügen.

### <a name="additional-methods-for-adding-users"></a>Zusätzliche Methoden zum Hinzufügen von Benutzern

Wenn Sie sich mit einem Managerkonto angemeldet haben, das über [globale Administrator](http://go.microsoft.com/fwlink/?LinkId=746654)berechtigungen für den von Ihnen verwendeten Azure AD-Mandanten verfügt, werden zusätzliche Optionen angeboten, um dem Dev Center-Konto Benutzer hinzuzufügen. Sie müssen eine der folgenden Optionen auswählen:

-   **Add existing users** (Vorhandene Benutzer hinzufügen): Wählen Sie Benutzer aus, die bereits im Verzeichnis der Organisation vorhanden sind, und gewähren Sie ihnen Zugriff auf Ihr Dev Center-Konto wie oben beschrieben.
-   **Neue Benutzer erstellen**: Erstellen Sie ein völlig neues Benutzerkonto für das Verzeichnis Ihrer Organisation und Ihr Dev Center-Konto.
...
1.  Klicken Sie auf der Seite **Benutzer** auf den Namen des Benutzerkontos, das bearbeitet werden soll.
...
1.  Klicken Sie auf der Seite **Benutzer** auf **Gruppen hinzufügen**.
...
2.  Wählen Sie eine oder mehrere Azure AD-Anwendungen aus der angezeigten Liste aus. Mithilfe des Suchfelds können Sie nach bestimmten Azure AD-Anwendungen suchen.
    > [!TIP]
...
1.  Klicken Sie auf der Seite **Benutzer** auf den Namen der Azure AD-App.
    > [!TIP]
...
1.  Klicken Sie auf der Seite **Benutzer** auf den Namen des Benutzer-, Gruppen- oder Azure AD-Anwendungskontos, das bearbeitet werden soll.
