...
ms.prod: windows
ms.technology: uwp
keywords: Windows 10, Uwp, Azure Ad-Anwendung, Aad, Benutzer, Gruppe, mehrere Benutzer, Mehrbenutzer
...
1.  Wählen Sie das Zahnradsymbol (in der Nähe der oberen rechten Ecke des Dashboards) aus, und wählen Sie dann **kontoeinstellungen**. Wählen Sie im Menü **Einstellungen** **Benutzer**.
...
-   **Hinzufügen von vorhandenen Benutzern**: Wählen Sie Benutzer, die bereits in das Verzeichnis der Organisation vorhanden sind, und gewähren sie Zugriff auf Ihr Konto Developer Center der oben beschriebenen Methoden verwenden.
-   **Erstellen neuer Benutzer**: Erstellen Sie neue Benutzerkonten so sowohl das Verzeichnis der Organisation hinzu und Ihr Konto Developer Center
...
1.  Wählen Sie auf der Seite **Benutzer** (unter **Konten-Einstellungen**) **Benutzer hinzufügen**, und wählen Sie dann **neue Benutzer erstellen**.
...
1.  Wählen Sie auf der Seite **Benutzer** (unter **Konten-Einstellungen**) **Benutzer hinzufügen**, und wählen Sie dann **Benutzer per e-Mail einladen**.
...
1.  Wählen Sie auf der Seite **Benutzer** (unter **kontoeinstellungen**) den Namen des Benutzerkontos, die Sie bearbeiten möchten.
2.  Wählen Sie die Schaltfläche **Zurücksetzen des Kennworts** am unteren Rand der Seite aus.
...
1.  1.  Wählen Sie das Zahnradsymbol (in der Nähe der oberen rechten Ecke des Dashboards) aus, und wählen Sie dann **kontoeinstellungen**. Wählen Sie im Menü **Einstellungen** **Benutzer**.
...
1.  Wählen Sie auf der Seite **Benutzer** (unter **kontoeinstellungen**) **Azure AD-Applikationen hinzufügen**.
2.  Wählen Sie auf der nächsten Seite **neue Azure AD-Anwendung**.
...
1.  Wählen Sie auf der Seite **Benutzer** (unter **kontoeinstellungen**) den Namen der Azure AD-Anwendung.
    > [!TIP]
...
4.  Wenn Sie weitere Schlüssel erstellen möchten, wählen Sie **einen anderen Schlüssel hinzufügen**aus.
...
1.  Wählen Sie auf der Seite **Benutzer** (unter **kontoeinstellungen**) den Namen des Benutzers, der Gruppe oder der Azure AD-Anwendung-Konto, das Sie bearbeiten möchten.
...
Wählen Sie auf der Seite **Benutzer** (unter **kontoeinstellungen**) den Link unter **letzte Aktivität** angezeigt wird, für den Benutzer, dessen Verlauf Sie überprüfen möchten. Sie können die URLs aller Seiten anzeigen, die der Benutzer in den letzten 30Tagen besucht habt.

<span id="remove" />

## <a name="remove-users-groups-and-azure-ad-applications"></a>Entfernen von Benutzern, Gruppen und Azure AD-Anwendungen

Um Ihr Konto Developer Center für Benutzer, Gruppe oder Azure AD-Anwendung zu entfernen, wählen Sie den Link **Entfernen** , der mit ihrem Namen auf der Seite **Benutzer** angezeigt wird. Nachdem Sie das Entfernen bestätigt haben, kann der Benutzer, die Gruppe oder die Azure AD-Anwendung nicht mehr auf Ihr Dev Center-Konto zugreifen (es sei denn, Sie fügen das Element später wieder hinzu).
