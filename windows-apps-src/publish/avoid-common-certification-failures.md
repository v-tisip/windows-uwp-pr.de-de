...
> [!NOTE]
> Stellen Sie sicher, dass Sie außerdem die [Windows Store-Richtlinien](https://msdn.microsoft.com/library/windows/apps/dn764944) lesen, um sicherzustellen, dass Ihre App alle darin aufgeführten Anforderungen erfüllt.
