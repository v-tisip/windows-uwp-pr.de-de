...
Standard (Windows 10) Store-Eintrag können als Ausgangsbasis verwenden, wodurch Texte und Bilder für Ihren standardmäßigen Store eingegebene Eintrag. Sie werden dann in der Lage zu ändern, die Sie vor dem speichern möchten. Alternativ können Sie mit einem vollständig leeren Store-Eintrag starten.
...
Sie können weiterhin plattformspezifische Einträge zu bearbeiten, wie Sie Änderungen für Kunden auf eine bestimmte Version des Betriebssystems erforderlich.
