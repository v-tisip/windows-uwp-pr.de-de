...
Kunden unter Windows 10 (einschließlich Xbox) werden immer die standardmäßige [Store-Eintrag](create-app-store-listings.md)angezeigt. Die Option zum plattformspezifischen Store-Einträge zu erstellen, es sei denn, Sie bereits Ihre app mit Paketen veröffentlicht haben, die eine oder mehrere frühere Betriebssystemversionen unterstützen werden nicht angezeigt. 
...
Plattformspezifische Store-Einträge können nützlich sein, wenn Sie Features auswirken, die nur in einer Betriebssystemversion angezeigt werden sollen, oder Screenshots bereitstellen, die für ein bestimmtes Betriebssystem (unabhängig vom Gerätetyp) spezifisch sind.
...
Am oberen Rand der **Store-Eintrag** Seite aus, wenn Ihre app zuvor veröffentlichten Pakete enthält, die für frühere Betriebssystemversionen unterstützen ((Windows 8.x oder früher und/oder Windows Phone 8.x oder früher), Sie können wählen **erstellen ein plattformspezifischen app Store-Eintrags **. Nach Auswahl dieser Option werden Sie aufgefordert, die gewünschten Betriebssystemversionen auszuwählen, die Ihre Übermittlung unterstützen. Wenn Sie bereits plattformspezifische Store-Einträge für alle früheren Betriebssystemversionen Ihre app ausgerichtet ist erstellt haben, nicht Sie eine andere Auswahl vornehmen.

Sie können Store-Eintrag Standardwert (Windows 10) als Ausgangspunkt, wodurch Texte und Bilder für Ihren standardmäßigen Store eingegebene Eintrag. Sie sehen dann möglicherweise keine Änderungen vornehmen, die Sie vor dem speichern möchten. Alternativ können Sie mit einem vollständig leeren Store-Eintrag starten.
...
Sie können weiterhin plattformspezifische Einträge zu bearbeiten, je nach Bedarf ändern für Kunden auf eine bestimmte Version des Betriebssystems.
