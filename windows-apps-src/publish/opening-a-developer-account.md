...
description: Hier ist eine Übersicht zur Registrierung für ein Entwicklerkonto Entwicklungskit für den Microsoft Store und anderen Microsoft-Programmen im Partner Center erleichtert.
ms.date: 10/31/2018
ms.topic: article
...
1.  Wechseln Sie zur [Registrierungsseite](https://go.microsoft.com/fwlink/p/?LinkId=615100), und klicken Sie auf **Registrieren**.
...
> [!IMPORTANT]
> Damit um mehrere Benutzer auf Ihr Entwicklerkonto zugreifen zu können, empfehlen wir die Verwendung von Azure Active Directory Zuweisen von Rollen zu einzelnen Benutzern (statt Freigabe Zugriff auf das Microsoft-Konto). Jeder Benutzer kann dann das Entwicklerkonto zugreifen, indem die Anmeldung beim Partner Center mit seinen individuellen Azure AD-Anmeldeinformationen. Weitere Informationen finden Sie unter [Verwalten von Kontobenutzern](manage-account-users.md).

Das Unternehmenskonto durch Signieren mit Microsoft-Konto, das es geöffnet (und nicht als einzelne Benutzer, dem Konto hinzugefügt), die folgenden Richtlinien kann hilfreich sein, wenn Sie mehrere Personen zugreifen müssen:

-   Erstellen Sie das Microsoft-Konto mit einer e-Mail-Adresse, die bereits Ihnen oder einer anderen Person wie z. B. gehört MyCompany_PartnerCenter@outlook.com. Verwenden Sie eine e-Mail-Adresse nicht an der Domäne Ihres Unternehmens, insbesondere dann, wenn Ihr Unternehmen bereits Azure AD verwendet. (Wie bereits erwähnt, können Sie weitere Benutzer hinzufügen, von Ihres Unternehmens Azure AD weiter unten.)
-   Beschränken Sie den Zugriff auf dieses Microsoft-Konto auf so wenige Benutzer wie möglich.
-   Richten Sie eine firmeninterne e-Mail-Verteilerliste ein, die alle Benutzer enthält, die Zugriff auf das Entwicklerkonto benötigen, und hinzuzufügen Sie die [Sicherheitsinformationen, die mit dem Microsoft-Konto verknüpften](https://account.microsoft.com/security)e-Mail-Adresse. Dadurch können alle Mitarbeiter auf der Liste an diesen Aliasnamen gesendet Sicherheitscodes erhalten. Wenn das Einrichten eine Verteilerliste nicht realisierbar ist, Sie können Ihre Sicherheitsinformationen e-Mail-Adresse eines einzelnen Benutzers hinzufügen, der Besitzer der e-Mail-Adresse werden jedoch einzige Person zugreifen kann, und teilen den Sicherheitscode bei entsprechender Aufforderung (z. B. wenn t neue Sicherheitsinformationen hinzugefügt werden er für das Konto, oder wenn sie von einem neuen Gerät zugegriffen wird).
