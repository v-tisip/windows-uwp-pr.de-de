...
> **Hinweis**  Die Versionsnummer des entsprechenden Windows10-Pakets muss höher sein als die der Pakete für Windows8, Windows8.1 und/oder WindowsPhone8.1, die Sie für die gleiche App veröffentlichen (oder der Pakete für diese Betriebssystemversionen, die Sie zuvor veröffentlicht haben). Weitere Informationen finden Sie unter [Paketversionsnummern](package-version-numbering.md).
...
> **Wichtig**  Beachten Sie beim Bereitstellen von Paketen für die universelle Gerätefamilie, dass jeder Kunde, der Ihre App bereits auf einem früheren Betriebssystem (WindowsPhone8, Windows8.1 usw.) verwendet hat und anschließend ein Upgrade auf Windows10 ausführt, auf Ihr Windows10-Paket aktualisiert wird.
> 
...
> 
> Weitere Informationen über Gerätefamilien finden Sie unter [Anleitung für UWP (Universelle Windows-Plattform)-Apps](../get-started/universal-application-platform-guide.md).
