...
> [!NOTE]
> Weitere Informationen und Anforderungen in Bezug auf Ihre Verwendung der Microsoft Store-Signals [App-marketing-Richtlinien](app-marketing-guidelines.md) zu.


## <a name="linking-directly-to-your-app-in-the-microsoft-store"></a>Direkt an Ihre app im Microsoft Store verknüpfen

Sie können einen Link erstellen, startet der Microsoft Store und direkt zur Eintragsseite für Ihre app wechselt, ohne einen Browser öffnen, mit, der **ms-Windows-Store:** URI-Schema.
