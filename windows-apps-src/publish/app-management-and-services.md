...
f Ihr Produkt mit Azure AD integriert und APIs aufruft, die eine [Anwendung oder delegierte Berechtigungen verfügen](https://developer.microsoft.com/graph/docs/concepts/permissions_reference) anfordern, die Zustimmung des Administrators, erfordern Geben Sie Ihre Azure AD-Client-ID ein. Dadurch können Administratoren die app für ihre Organisation Grant Zustimmung für Ihr Produkt, die für alle Benutzer im Mandanten fungieren erwerben.
