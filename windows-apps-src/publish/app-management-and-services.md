...
Wenn Sie ein Spiel veröffentlichen, können Sie die [Xbox Live Creators-Programm](http://xbox.com/developers/creators-program) auf dieser Seite aktivieren. Auf diese Weise können Sie konfigurieren und Testen Xbox Live-Features starten, und schließlich veröffentlichen Sie Ihr Spiel Xbox Live Creators-Programm.
...
Um den Zugriff auf Besitzerinformationen für apps und Add-ons im Microsoft Store-Sammlungs-API und der Microsoft Store-Einkaufs-API zu verwenden, müssen Sie das zugeordnete geben hier Azure AD-Client-IDs. Beachten Sie, dass es bis zu 16 Stunden dauern kann, bis diese Änderungen wirksam werden.
...
f Ihr Produkt in Azure AD integriert werden und APIs aufruft, die eine [Anwendung oder delegierte Berechtigungen verfügen](https://developer.microsoft.com/graph/docs/concepts/permissions_reference) anfordern, die Zustimmung des Administrators, erfordern Geben Sie Ihre Azure AD-Client-ID ein. Dadurch können Administratoren die app für ihre Organisation Grant Zustimmung für Ihr Produkt, die für alle Benutzer im Mandanten fungieren erwerben.
