...
Sie können einfache Codes generieren (und verteilen Sie eine jeder Kunde) oder die Möglichkeit, einen Code, der verwendet werden kann mehrere Male durch eine bestimmte Anzahl von Kunden zu generieren.
