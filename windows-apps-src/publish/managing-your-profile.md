...
Um die kontoeinstellungen anzuzeigen, klicken Sie auf das Zahnradsymbol in der rechten oberen Ecke des Dashboards, und wählen Sie **Einstellungen für Entwickler**. Hier finden Sie Details zu Ihr Konto und Links zu anderen Seiten, in dem Sie Informationen anzeigen und verschiedene Aufgaben im Zusammenhang mit dem Konto durchführen können.

Der Abschnitt **Kontodetails** gibt Aufschluss über Status und Art des Kontos. Sie können auch Ihre Verkäufer-ID und andere Publisher-ID-Info hier sehen. Diese Werte werden von Microsoft zur eindeutigen Identifizierung der Entwicklerkonto zugewiesen und können nicht bearbeitet werden.
...
- **Überprüfen des Status**: Wenn Ihr Konto durchgeführt wird die Überprüfung verarbeitet werden (beispielsweise, wenn Sie sich zuerst anmelden oder nachdem Sie Ihre Kontaktinformationen erheblich aktualisiert), Sie können hier Ihr Überprüfung Status überprüfen.
- **Developer Center Insider Programm**: Sie können Ihre an- und Abmelden [Dev Center Insider Programm](dev-center-insider-program.md) im Hauptfenster von Seite **Konten-Einstellungen** .
...
- **Mandanten**: Verwalten Ihrer Azure AD-Mandanten Zuordnungen. Weitere Informationen finden Sie unter [zuordnen Azure AD mit Ihrem Konto Developer Center](associate-azure-ad-with-dev-center.md).
...
- **Developer Devices**: anzeigen und Verwalten von [Windows Phone 8.x Geräte, die Sie für das Testen entsperrt haben](http://go.microsoft.com/fwlink/p/?LinkId=533897) und [eine Xbox-Konsolen für die Entwicklung aktiviert](../xbox-apps/devkit-activation.md). 
