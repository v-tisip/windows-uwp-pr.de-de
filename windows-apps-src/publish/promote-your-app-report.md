...
Mithilfe des **Bericht „Anzeigenkampagne“s** im Windows Dev Center-Dashboard können Sie sehen, wie Ihre App-Werbekampagnen funktionieren.

Um den Bericht anzuzeigen, erweitern Sie **Bewerben** im linken Navigationsmenü und wählen Sie **Anzeigenkampagnen** (oder innerhalb einer App, erweitern Sie den Bereich **Monetisierung** und wählen Sie **Ihre App bewerten**) aus. 
