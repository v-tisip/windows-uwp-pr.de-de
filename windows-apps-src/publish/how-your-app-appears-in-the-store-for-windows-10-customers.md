...
## <a name="apps-that-shared-identity-in-the-windows-store-and-windows-phone-store"></a>Apps mit einer gemeinsamen Identität im WindowsStore und im WindowsPhone Store
...
Wenn Ihre App in den beiden Stores in verschiedenen Kategorien angezeigt wurde, verwenden wir die Kategorie aus dem WindowsStore, um die neue Kategorie festzulegen. Beachten Sie, dass einige Kategorien im Store für Windows10-Kunden unterschiedlich sind. Überprüfen Sie daher die folgende [table](#category-changes).
