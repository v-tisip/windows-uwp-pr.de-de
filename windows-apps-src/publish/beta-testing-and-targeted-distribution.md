...
Die Option **private Zielgruppe** kann mit Apps für jede Betriebssystemversion verwendet werden, Ihre Tester müssen allerdings Windows10, Version 1607 oder höher ausführen (einschließlich Xbox One), und müssen mit dem Microsoft-Konto angemeldet sein, das mit der von Ihnen bereitstellen der E-Mail-Adresse verknüpft ist.
...
Wenn Sie eine App nur an eine bestimmte Gruppe von Testern verteilen möchten, ohne vorher eine allgemein verfügbare Übermittlung zu veröffentlichen, ist dies eine zusätzliche Option. Allerdings kann im Gegensatz zu den privaten Zielgruppenoptionen möglicherweise jeder Benutzer den App-Eintrag sehen, wenn er über den direkten Link verfügt. Wenn die Vertraulichkeit für Ihre Übermittlung entscheidend ist, empfehlen wir stattdessen, diese nur an eine private Zielgruppe zu veröffentlichen.
