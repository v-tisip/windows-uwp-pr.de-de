---
author: jnHs
Description: "Der Xbox Analysebericht im Windows Dev Center-Dashboard zeigt Ihnen Statistiken darüber an, wie Ihre Kunden die Xbox-Features in Ihrem Produkt nutzen."
...
> [!IMPORTANT]
> Dieser Bericht wird nur angezeigt, wenn Sie ein Spiel für Xbox oder ein Spiel veröffentlichen, das Xbox Live-Dienste verwendet. Hierfür müssen Sie das [Xbox Live Creators-Programm](../xbox-live/get-started-with-creators/get-started-with-xbox-live-creators.md) aktivieren oder durch den [Konzeptgenehmigungsprozess](../gaming/concept-approval.md) gehen. 
