...
3.  Aktivieren Sie den Entwicklermodus für Ihren Entwicklungs-PC (**Einstellungen / Update und Sicherheit / für Entwickler bzw. Entwicklerfeatures / Entwicklermodus**).
...
1.  Aktivieren Sie den Entwicklermodus auf der Xbox One. Herunterladen Sie die app, erhalten Sie den Aktivierungscode, und geben sie dann in das [Verwalten von Xbox One-Konsolen](https://partner.microsoft.com/xboxactivate) -Seite im Dev Center-Konto. Weitere Informationen finden Sie unter [Aktivierung des Xbox One-Entwicklermodus](devkit-activation.md). 
