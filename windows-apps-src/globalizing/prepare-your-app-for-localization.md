...
# <a name="prepare-your-app-for-localization"></a>Vorbereiten Ihrer App für die Lokalisierung
...
## <a name="use-resource-files-and-qualifiers"></a>Verwenden Sie Ressourcendateien und Qualifizierer.
...
## <a name="add-contextual-comments"></a>Fügen Sie Kontextkommentare hinzu.
...
## <a name="localize-sentences-instead-of-words"></a>Lokalisieren Sie Sätze anstelle von Wörtern.
...
## <a name="ensure-the-correct-parameter-order"></a>Stellen Sie sicher, dass die Parameterreihenfolge richtig ist.
...
## <a name="do-not-use-the-same-strings-in-dissimilar-contexts"></a>Verwenden Sie nicht die gleichen Zeichenfolgen in unterschiedlichen Kontexten.
...
## <a name="identify-resources-with-unique-attributes"></a>Identifizieren Sie Ressourcen anhand eindeutiger Attribute.
...
## <a name="choose-an-appropriate-translation-approach"></a>Entscheiden Sie sich für den richtigen Übersetzungsansatz.
...
## <a name="keep-access-keys-and-labels-consistent"></a>Verwenden Sie Zugriffstasten und Bezeichnungen konsistent.
...
## <a name="support-furigana-for-japanese-strings-that-can-be-sorted"></a>Unterstützung von Furigana für sortierbare japanische Zeichenfolgen.
