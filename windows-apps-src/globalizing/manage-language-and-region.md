...
### <a name="users-can-set-their-language-preferences"></a>Benutzer können ihre Spracheinstellungen festlegen.
...
### <a name="specify-the-supported-languages-in-the-apps-manifest"></a>Geben Sie die unterstützten Sprachen im App-Manifest an.
...
### <a name="specify-the-default-language"></a>Angeben der Standardsprache.
...
### <a name="set-the-http-accept-language-header"></a>Legen Sie den HTTP-Header „Accept Language“ fest.
...
### <a name="use-the-apis-in-the-windowsglobalization-namespace"></a>Verwenden Sie die APIs im Windows.Globalization-Namespace.
