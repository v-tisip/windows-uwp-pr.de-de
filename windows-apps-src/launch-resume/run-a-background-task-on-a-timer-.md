...
Der integrierte Timer für auf Desktop- oder Mobilgeräte ausgerichtete UWP-Apps führt Hintergrundaufgaben in einem 15-Minuten-Intervall aus. (Der Timer führt alle 15 Minuten, damit vom System benötigt nur an alle 15 Minuten zu aktivieren, um Reaktivieren von apps, die ein/aus speichert TimerTriggers – angefordert haben.)
...
Eine Hintergrundaufgabe ausgeführt wird nur mithilfe einer **TimeTrigger** , wenn Sie [**RequestAccessAsync**](https://msdn.microsoft.com/library/windows/apps/hh700485) zuerst aufgerufen haben.
