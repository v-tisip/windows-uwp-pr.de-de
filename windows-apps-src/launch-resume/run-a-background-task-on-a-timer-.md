...
Der integrierte Timer für auf Desktop- oder Mobilgeräte ausgerichtete UWP-Apps führt Hintergrundaufgaben in einem 15-Minuten-Intervall aus. (Der Timer ausgeführt wird in alle 15 Minuten, damit das System muss nur reaktiviert werden alle 15 Minuten Reaktivieren von apps, die Energie speichert TimerTriggers – angefordert haben.)
...
Eine Hintergrundaufgabe ausgeführt wird nur eine **TimeTrigger** verwenden, wenn Sie [**RequestAccessAsync**](https://msdn.microsoft.com/library/windows/apps/hh700485) zuerst aufgerufen haben.
