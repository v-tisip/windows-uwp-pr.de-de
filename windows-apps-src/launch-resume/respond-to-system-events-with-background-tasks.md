...
> [!NOTE]
> Universelle Plattform Windows-apps müssen [**RequestAccessAsync**](https://msdn.microsoft.com/library/windows/apps/hh700485) aufrufen, vor dem Hintergrund Trigger Typen registrieren.
