...
Im obigen XML stellen sicher, dass die `EntryPoint` -Attribut auf den namespace.class Namen der Klasse Aufgabe Update festgelegt ist. Der Name ist Groß-/Kleinschreibung berücksichtigt.
...
Nun in Visual Studio 2017 Wenn Sie F5 drücken, wird Ihre app aktualisiert werden und das System wird die UpdateTask-Komponente im Hintergrund aktivieren. Der Debugger wird automatisch im Hintergrundprozess zuordnen. Der Haltepunkt wird erreicht erhalten und können Sie Ihre Update-Codelogik durchlaufen.
