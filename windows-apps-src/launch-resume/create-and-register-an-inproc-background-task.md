...
Eine umfassende **OnBackgroundActivated** Beispiel finden Sie unter [Konvertieren einen app-Dienst in demselben Prozess wie die Host-app ausgeführt](convert-app-service-in-process.md).
