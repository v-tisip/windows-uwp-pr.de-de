...
Eine Hintergrundaufgabe wird nur ausgeführt mit einer **ApplicationTrigger** , wenn Sie [**RequestAccessAsync**](https://msdn.microsoft.com/library/windows/apps/hh700485) zuerst aufgerufen haben.
