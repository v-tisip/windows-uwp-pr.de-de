...
Legen Sie die Codierungseigenschaften, die vom Effekt unterstützt werden sollen, mit der [**SupportedEncodingProperties**](https://msdn.microsoft.com/library/windows/apps/dn764799)-Eigenschaft fest. Wenn Sie mit Win2D arbeiten, müssen Sie die ARGB32-Codierung verwenden.
...
Die Implementierung von [**SetProperties**](https://msdn.microsoft.com/library/windows/apps/br240986) ist mit dem vorherigen Beispiel zur Softwareverarbeitung identisch. Bei diesem Beispiel wird eine **BlurAmount**-Eigenschaft verwendet, um einen Win2D-Weichzeichnereffekt zu konfigurieren.
