...
<table>
    ...
    <tr>
        <th>270</th>
        <td>**SWDRM**: Versucht, HDCP einzubinden. Sollte die Einbindung von HDCP nicht möglich sein, schränkt der PC die effektive Auflösung auf 520.000Pixel pro Frame ein und übergibt den Inhalt.</td>
        <td>**HWDRM**: Inhalt wird mit HDCP übergeben. Wenn die Einbindung von HDCP nicht möglich ist, wird die Wiedergabe über HDMI/DVI-Anschlüsse blockiert.</td>
    </tr>
    <tr>
        <th>300</th>
        <td colspan="2">
...
## <a name="playready-windows-store-app-migration-guide"></a>Migrationshandbuch für WindowsStore-Apps mit PlayReady
