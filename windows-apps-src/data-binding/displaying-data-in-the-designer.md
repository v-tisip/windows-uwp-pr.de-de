...
**<span data-ttu-id="f6cbc-112">Beispiel-Apps zur Veranschaulichung von {Binding}</span><span class="sxs-lookup"><span data-stu-id="f6cbc-112">Sample apps that demonstrate {Binding}</span></span>**
