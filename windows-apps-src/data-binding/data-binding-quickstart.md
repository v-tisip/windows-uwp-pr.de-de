...
Wenn Sie verwenden [C++ / WinRT](/windows/uwp/cpp-and-winrt-apis/intro-to-using-cpp-with-winrt), und klicken Sie dann erste Update `MainPage.idl`. Erstellen Sie das Projekt neu generieren `MainPage.h` und `.cpp`, und fügen Sie die Änderungen in die generierten Dateien in derjenigen, die in Ihrem Projekt.
