...
ms.locfileid: "5692006"
---
# <a name="numeralsystem-values"></a>NumeralSystem-Werte

In diesem Thema werden die für die **NumeralSystem**-Eigenschaft von verschiedenen Klassen im [**Windows.Globalization**](/uwp/api/windows.globalization?branch=live)-Namespace verfügbaren Werte aufgeführt. Diese Klassen enthalten eine **NumeralSystem**-Eigenschaft.
...
Die **NumeralSystem**-Eigenschaft gibt das von der Klasse verwendete NumeralSystem an. Die Eigenschaft ist eine Zeichenfolge wie „Latn” für das lateinische Ziffernsystem (0123456789) oder „Arab” für das arabisch-indische Ziffernsystem (٠١٢٣٤٥٦٧٨٩).

Dies sind die Werte für **NumeralSystem**, die von Windows unterstützt werden.

| NumeralSystem-Wert | Beschreibung | Unicode-Codepunkte |
| -------------------- | ----------- | ------------------- |
| Arab | Arabisch-Indisch | U+0660, U+0661, U+0662, U+0663, U+0664, U+0665, U+0666, U+0667, U+0668, U+0669 |
| ArabExt | Arabisch-Indisch erweitert | U+06F0, U+06F1, U+06F2, U+06F3, U+06F4, U+06F5, U+06F6, U+06F7, U+06F8, U+06F9 |
| Bali | Balinesisch | U+1B50, U+1B51, U+1B52, U+1B53, U+1B54, U+1B55, U+1B56, U+1B57, U+1B58, U+1B59 |
...
| FullWide | Volle Breite | U+FF10, U+FF11, U+FF12, U+FF13, U+FF14, U+FF15, U+FF16, U+FF17, U+FF18, U+FF19 |
...
| Mong | Mongolisch | U+1810, U+1811, U+1812, U+1813, U+1814, U+1815, U+1816, U+1817, U+1818, U+1819 |
...
| Sund | Sundanesisch | U+1BB0, U+1BB1, U+1BB2, U+1BB3, U+1BB4, U+1BB5, U+1BB6, U+1BB7, U+1BB8, U+1BB9 |
| Talu | Neu-Tai-Lue | U+19D0, U+19D1, U+19D2, U+19D3, U+19D4, U+19D5, U+19D6, U+19D7, U+19D8, U+19D9 |
...
| Thailändisch | Thailändisch | U+0E50, U+0E51, U+0E52, U+0E53, U+0E54, U+0E55, U+0E56, U+0E57, U+0E58, U+0E59 |
| Tibt | Tibetisch | U+0F20, U+0F21, U+0F22, U+0F23, U+0F24, U+0F25, U+0F26, U+0F27, U+0F28, U+0F29 |
