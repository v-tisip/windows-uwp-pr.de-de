...
:::row:::
    ...
    :::column:::
       ...
       <span data-ttu-id="e29be-107">Typografie muss übersichtlich sein, da sie zur visuellen Darstellung von Sprache dient.</span><span class="sxs-lookup"><span data-stu-id="e29be-107">As the visual representation of language, typography’s main task is to be clear.</span></span> <span data-ttu-id="e29be-108">Ihr Stil darf diesem Ziel nie im Wege stehen.</span><span class="sxs-lookup"><span data-stu-id="e29be-108">Its style should never get in the way of that goal.</span></span> <span data-ttu-id="e29be-109">Die folgenden Richtlinien konzentrieren, wie Sie die Typografie verwenden, um Benutzern Inhalte leicht verständlich zu erleichtern.</span><span class="sxs-lookup"><span data-stu-id="e29be-109">The following guidelines focus on how to use typography to help users understand content easily.</span></span> 
    :::column-end:::
:::row-end:::
