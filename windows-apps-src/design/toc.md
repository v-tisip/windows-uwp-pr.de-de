...
### [Implementieren von grundlegender Navigation](basics/navigate-between-two-pages.md)
...
## [Umschalten](controls-and-patterns/toggles.md)
...
### [Storyboardanimationen](motion/storyboarded-animations.md)
...
#### [Sekundäre Kacheln anheften](shell/tiles-and-notifications/secondary-tiles-pinning.md)
...
#### [Benachrichtigung-Listener](shell/tiles-and-notifications/notification-listener.md)
#### [Benachrichtigungspiegelung](shell/tiles-and-notifications/notification-mirroring.md)
...
### [Speichern und Abrufen von letzten Strichen](input/save-and-load-ink.md)
### [Hinzufügen eines InkToolbar-Elements](input/ink-toolbar.md)
...
### [Ändern der Bildschirmtastatur mithilfe der InputScope-Eigenschaft](input/use-input-scope-to-change-the-touch-keyboard.md)
...
### [Multilingual App Toolkit 4.0 – Fragen und Antworten sowie Problembehandlung](globalizing/mat-faq-troubleshooting.md)
