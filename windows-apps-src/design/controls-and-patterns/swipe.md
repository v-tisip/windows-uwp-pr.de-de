...
- [<span data-ttu-id="3e4f5-197">Listenansicht und Rasteransicht</span><span class="sxs-lookup"><span data-stu-id="3e4f5-197">List view and Grid view</span></span>](listview-and-gridview.md)
