...
## <a name="menus-vs-context-menus"></a><span data-ttu-id="0491f-116">Vergleich zwischen Menüs und Kontextmenüs</span><span class="sxs-lookup"><span data-stu-id="0491f-116">Menus vs. context menus</span></span>
