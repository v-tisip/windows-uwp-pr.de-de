...
---
# <a name="create-custom-styles"></a>Erstellen eigener Stile
...
Um einen Stil zu definieren, fügen Sie ein [Stil](https://msdn.microsoft.com/library/windows/apps/br208849)-Element in die [Ressourcen](https://docs.microsoft.com/en-us/uwp/api/windows.ui.xaml.frameworkelement#Windows_UI_Xaml_FrameworkElement_Resources)-Eigenschaft eines Elements ein, das das Steuerelement enthält, das Sie formatieren möchten.  Wenn Sie Ihren Stil der **Page.Resources**-Eigenschaft hinzufügen, werden Ihre Stile für die gesamte Seite zugängig. Wenn Sie Ihren Stil der **Application.Resources**-Eigenschaft in der Datei App.xaml hinzufügen, wird der Stil wird für die gesamte App zugänglich.
