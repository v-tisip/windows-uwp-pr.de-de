...
> [!TIP]
> Weitere Informationen zum Öffnen anderer apps und Websites über Ihre app finden Sie unter den Themen unter [Starten einer app mit einem Uri](/windows/uwp/launch-resume/launch-app-with-uri).
