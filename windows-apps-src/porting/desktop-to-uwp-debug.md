...
Zum Testen Ihrer Anwendung in einer realistischen, wie Sie vor der Verteilung, empfiehlt es sich, Signieren Sie Ihre Anwendung, und installieren Sie es.
...
3. Signieren Sie die Anwendung mithilfe dieses Zertifikat, finden Sie unter [Signieren eines app-Pakets mit SignTool](../packaging/sign-app-package-using-signtool.md).
