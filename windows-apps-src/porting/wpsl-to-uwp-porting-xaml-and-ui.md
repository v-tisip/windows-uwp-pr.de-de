...
Manchmal müssen Sie zum Reparieren von imperativem Code nur den Typ eines Parameters ändern. In anderen Fällen müssen Sie anstelle von .NET APIs für Windows-Runtime 8.x apps UWP APIs verwenden. Zum Identifizieren der APIs werden unterstützt, verwenden Sie den Rest dieses Handbuchs Portieren in Kombination mit [.NET für Windows-Runtime 8.x apps Overview](https://msdn.microsoft.com/library/windows/apps/xaml/br230302.aspx) und die [Windows-Runtime-Referenz](https://msdn.microsoft.com/library/windows/apps/br211377).
