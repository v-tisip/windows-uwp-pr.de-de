...
Manchmal müssen Sie zum Reparieren von imperativem Code nur den Typ eines Parameters ändern. In anderen Fällen müssen Sie UWP-APIs anstelle von .NET APIs für Windows-Runtime 8.x-apps zu verwenden. Identifizieren der unterstützten APIs, verwenden Sie den Rest dieses Handbuchs für in Kombination mit [Übersicht über .NET für Windows-Runtime 8.x-apps](https://msdn.microsoft.com/library/windows/apps/xaml/br230302.aspx) und der [Windows-Runtime-Referenz](https://msdn.microsoft.com/library/windows/apps/br211377).
...
Da 480 zuvor die feste Breite war in der Ansicht Pixel für einen Bildschirm Phone Größe und dieser Wert ist jetzt in der Regel kleiner in effektiven Pixeln, Faustregel alle Dimensionen im Markup Ihrer WindowsPhone Silverlight-app mit dem Faktor 0,8 multiplizieren.
