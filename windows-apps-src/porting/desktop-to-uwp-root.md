...
title: "Desktop-zu-Universelle-Windows-Plattform-Brücke (UWP-Brücke)"
ms.author: normesta
ms.date: 03/09/2017
ms.topic: article
ms.prod: windows
...
translationtype: HT
---
# <a name="desktop-to-universal-windows-platform-uwp-bridge"></a>Desktop-zu-Universelle-Windows-Plattform-Brücke (UWP-Brücke)
