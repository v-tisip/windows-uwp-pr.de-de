...
Genau wie die vorherige – Fallstudie, die Option, die wir nutzen (der in [bei einer universellen 8.1-app](w8x-to-uwp-root.md)beschrieben) Portieren ist-Projekts den Inhalt der Shared in einer Windows 10, das auf die universelle Gerätefamilie.
