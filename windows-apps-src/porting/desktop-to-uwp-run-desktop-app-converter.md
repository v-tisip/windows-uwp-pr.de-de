...
:heavy_check_mark: Überprüfen Ihrer App auf Anforderungen der Desktop-Brücke und des Microsoft Stores.
...
#### <a name="package-an-app-that-has-a-setup-executable-file"></a>Verpacken einer App, die eine ausführbare Setup-Datei hat
...
#### <a name="package-an-app-that-doesnt-have-an-installer"></a>Verpacken einer App, die kein Installationsprogramm besitzt
...
Dieses Beispiel ähnelt dem vorherigen, da es zeigt, wie Sie Ihre App für das lokale Testen signieren und Ihre App hinsichtlich der Desktop-Brücke- und Microsoft Store-Anforderungen überprüfen können.
...
| -Überprüfen [&lt;SwitchParameter&gt;] |Optional |Ein Switch, mit dem DAC angewiesen wird, das verpackte App-Paket auf Anforderungen von Desktop-Brücke und Microsoft Store zu überprüfen. Das Ergebnis ist ein Überprüfungsbericht „VerifyReport.xml“, der am besten in einem Browser angezeigt wird. Dieser Switch sollte ebenso vorhanden sein, wie der Switch `-MakeAppx`. |
