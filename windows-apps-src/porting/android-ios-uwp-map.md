...
<td align="left">In iOS gibt es <strong>keine Kacheln oder Widgets</strong>. Sie können dem Symbol ein <strong>Signal</strong> mit einer Zahl hinzufügen, die sich als Reaktion auf lokale oder Remotebenachrichtigungen ändert.</td>
