...
Wenn Sie Ihre WindowsPhone-Silverlight-app zu einer Windows 10-app portieren, werden Sie außerdem auf mobilen Features, die [mit Windows Phone 8.1 eingeführt](https://msdn.microsoft.com/library/windows/apps/dn632424)wurden, und gehen weit darüber hinaus die universelle Windows-Plattform (UWP), deren app-Modell und Benutzeroberflächenframework verwenden können universell auf allen Windows 10-Geräten gelten. Dies ermöglicht die Unterstützung von PCs, Tablets, Telefonen und einer großen Zahl von anderen Gerätearten – mit einer Codebasis und einem App-Paket. Zudem vervielfacht sich die potenzielle Zielgruppe Ihrer App, und Sie erhalten neue Möglichkeiten durch freigegebene Daten, gekaufte Consumables usw. [Was ist neu für Entwickler in Windows 10](https://dev.windows.com/getstarted/whats-new-windows-10)finden Sie weitere Informationen zu den neuen Features.
...
Ein weiterer guter Grund neu kompilieren, Ihre vorhandenen .NET-Quellcode in eine Windows 10-app besteht darin, dass Sie von .NET Native profitieren die eine ahead-des-kompilierungstechnologie, mit der MSIL nativ-Computercode konvertiert. .NET Native-Apps starten schneller, verbrauchen weniger Arbeitsspeicher und benötigen weniger Akkuenergie als ihre MSIL-Gegenstücke.
...
Die gute Nachricht ist, dass auf der Featureebene nur sehr wenig nicht in der UWP unterstützt wird. Wenn Sie den Rest dieses Handbuchs für das Portieren lesen, werden Sie feststellen, dass sich die meisten Ihrer Kenntnisse und der Großteil Ihres Quellcodes sehr gut auf UWP-Apps übertragen lassen. Hier sind jedoch einige WindowsPhone Silverlight Features, die Sie verwendet haben und vielleicht für die es kein UWP-äquivalent ist.
...
| [Portieren des Projekts](wpsl-to-uwp-porting-to-a-uwp-project.md) | Sie beginnen den portierungsprozess, erstellen ein neues Windows 10-Projekt in Visual Studio, und kopieren die Dateien in dieses. |
...
**Präsentationen**
* [Die Story der Nokia Music aus Windows Phone zu Windows8](http://go.microsoft.com/fwlink/p/?LinkId=321521)
 
