...
Ein weiterer guter Grund zum Neukompilieren von vorhandenen .NET Quellcodes in eine Windows 10-app besteht darin, dass Sie von .NET Native profitieren die eine ahead-des-kompilierungstechnologie, mit der MSIL nativ-Computercode konvertiert. .NET Native-Apps starten schneller, verbrauchen weniger Arbeitsspeicher und benötigen weniger Akkuenergie als ihre MSIL-Gegenstücke.
