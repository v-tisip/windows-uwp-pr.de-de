---
description: Wenn Sie ein mit einer WindowsPhone Silverlight-app-Entwickler sind, und klicken Sie dann Ihre und Fähigkeiten zurückgreifen und Ihren Quellcode beim Wechsel zu Windows 10 nutzen können.
...
**Hinweis:** Windows 10 unterstützt einen deutlich größeren von .NET Framework als Windows Phone Store-Apps. Beispielsweise hat Windows 10 verschiedene System.ServiceModel.\* Namespaces sowie System.Net, System.Net.NetworkInformation und System.Net.Sockets. Daher ist jetzt ein idealer Zeitpunkt für das Portieren von WindowsPhone Silverlight und Ihre .NET Code einfach kompilieren und auf der neuen Plattform funktionieren. Weitere Informationen finden Sie unter [Namespace- und Klassenzuordnungen](wpsl-to-uwp-namespace-and-class-mappings.md).
Ein weiterer guter Grund zum Neukompilieren von Ihrem vorhandenen .NET-Quellcodes in eine Windows 10-app besteht darin, dass Sie von .NET Native profitieren die eine ahead-des-kompilierungstechnologie, mit der MSIL nativ-Computercode konvertiert. .NET Native-Apps starten schneller, verbrauchen weniger Arbeitsspeicher und benötigen weniger Akkuenergie als ihre MSIL-Gegenstücke.
...
| [Portieren des Projekts](wpsl-to-uwp-porting-to-a-uwp-project.md) | Sie beginnen den portierungsprozess durch Erstellen eines neuen Windows 10-Projekts in Visual Studio, und kopieren Ihre Dateien in dieses. |
...
| [Portieren von XAML und UI](wpsl-to-uwp-porting-xaml-and-ui.md) | Die Vorgehensweise zum Definieren einer Benutzeroberfläche in Form von deklarativem XAML-Markup lässt sich sehr gut von WindowsPhone Silverlight auf UWP-apps. Sie werden feststellen, dass große Abschnitte Ihres Markups kompatibel sind, sobald Sie Verweise auf Systemressourcenschlüssel aktualisiert, einige Namen von Elementtypen geändert und „clr-namespace“ in „using“ geändert haben. |
...
* [Visual Studio Magazine: Windows Phone8.1: Ein Riesenschritt für die Konvergenz](https://go.microsoft.com/fwlink/p/?LinkID=398541)

**Präsentationen**
* [Die Story der Nokia Music aus Windows Phone zu Windows8](https://go.microsoft.com/fwlink/p/?LinkId=321521)
 
