...
---
#  <a name="porting-windowsphone-silverlight-business-and-data-layers-to-uwp"></a>Portieren von WindowsPhone Silverlight Unternehmen und Daten-Ebenen zu UWP
...
Eine WindowsPhone Silverlight-app kann in einen Ruhezustand versetzt oder sogar als veraltet markiert versetzt werden, wenn z. B. die fotoauswahlaufgabe verwendet wird. Eine UWP-App bleibt aktiv und wird weiter ausgeführt, wenn die [**FileOpenPicker**](https://msdn.microsoft.com/library/windows/apps/br207847)-Klasse verwendet wird.
...
Obwohl eine Teilmenge des **Windows.Storage** -Namespace für sie verfügbar ist, führen viele WindowsPhone Silverlight-apps Datei-e/a mit **IsolatedStorageFile** Klasse, da es für schon länger unterstützt wird. Unter der Annahme, dass **IsolatedStorageFile** verwendet wird, ist hier ein vorher-nachher-Beispiel schreiben und Lesen einer Datei zunächst die WindowsPhone Silverlight-Version:
