...
* [Stellen Sie Ihre verpackte Anwendung und nicht Ihre desktop-app Dateien öffnet](#make)
...
### <a name="make-your-packaged-application-open-files-instead-of-your-desktop-app"></a>Stellen Sie Ihre verpackte Anwendung und nicht Ihre desktop-app Dateien öffnet
...
Wenn Ihre Anwendung Kommunikation über einen Anschluss erforderlich ist, können Sie Ihre Anwendung in der Liste der Firewallausnahmen hinzufügen.
...
* [Die Anwendung als Druckerziel in Anwendungen, die Unterstützung von Drucken angezeigt werden](#printing)
...
### <a name="make-your-application-appear-as-the-print-target-in-applications-that-support-printing"></a>Die Anwendung als Druckerziel in Anwendungen, die Unterstützung von Drucken angezeigt werden
...
```
Diese Erweiterung kann hilfreich sein, wenn Sie eine universelle Windows-Plattform-Benutzeroberfläche erstellen möchten, die auf allen Geräten ausgeführt wird, aber Komponenten der Win32-Anwendung weiterhin in voller Vertrauenswürdigkeit ausgeführt werden soll.
