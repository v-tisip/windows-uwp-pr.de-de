...
> [!IMPORTANT]
> Wenn Sie systemeigene Abbilder für Ihre Anwendung, die von der Windows Application Packaging Project gepackt erstellen möchten, stellen Sie sicher, dass die Ziel-Plattform-Mindestversion des Projekts auf das Windows Anniversary Update festgelegt.
...
Der systemeigene Bild-Compiler optimiert den Code für eine bestimmte Plattform. Um es zu verwenden, müssen Sie Ihre Anwendung eine bestimmte z. B. X86 oder X64 Zielplattform zu konfigurieren.
...
3. Das Dialogfeld **Neues Projektplattform** stellen Sie sicher, dass die **Kopie Einstellungen aus** Dropdown-Liste **Any CPU**eingestellt ist.
...
Um sicherzustellen, dass das Tool die Binärdateien verarbeitet hat können Sie überprüfen die Buildausgabe, um sicherzustellen, dass sie eine Nachricht wie dieses enthält:
...
A. Optimierte Binärdateien werden von der Verbesserungen profitieren, während der Ausführung mit .NET Framework 4.7.2. Clients, die vorherige .NET Framework-Versionen ausgeführt werden den nicht optimierten MSIL-Code aus der Binärdatei geladen.
