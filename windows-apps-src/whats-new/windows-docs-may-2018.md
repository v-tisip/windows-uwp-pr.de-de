...
ms.locfileid: "8926336"
---
# <a name="whats-new-in-the-windows-developer-docs-in-may-2018"></a>Was ist neu in der Windows-Entwicklerdokumentation im Mai 2018
...
Darüber hinaus haben wir die folgenden Seiten mit neuen Informationen zu ihren Inhaltsbereich umgeschrieben:
...
Anzeigen von Webinhalten in Ihrer desktop-Anwendung mit das WebView-Steuerelement, das zuvor nur für UWP-Anwendungen verfügbar. Dieses Steuerelement verwendet der Microsoft Edge Modul zu eine Ansicht einbetten rendert grafisch HTML formatiert Inhalte von einem Remotewebserver, dynamisch generiertem Code oder Inhaltsdateien rendern. Suchen Sie das WebView-Steuerelement in der aktuellen Version von der [Windows Community Toolkit.](https://docs.microsoft.com/windows/uwpcommunitytoolkit/)
...
MSIX ist auf der Microsoft Build 2018 Konferenz vorgestellt, ist ein neues Containerization-Paket-Format, das für alle Windows-Anwendungen, z. B. Win32, Windows Forms, WPF und UWP gilt. Dieses neue Format erbt großartige Features von UWP:
...
Tools, die diese Pakete zu erstellen, werden in einer zukünftigen Version von Visual Studio und Windows SDK verfügbar sein.

MSIX-Paketformat ist ein open-Source-Format mit einer für unsere Partner erleichtert mit der MSIX-Ökosystems, die Tools und Lösungen zu unterstützen. Weitere Informationen zu den MSIX-Paketformat zu erhalten, finden Sie unter [MSIX-SDK](https://github.com/Microsoft/msix-packaging). 
...
[Seitenübergänge](../design/motion/page-transitions.md) , wenn Benutzer zwischen Seiten in einer app navigieren. Sie können die Benutzer zu verstehen, wo sie in der Navigationshierarchie sind, und geben Sie Feedback über die Beziehung zwischen Seiten.

### <a name="project-rome"></a>Project Rome

Das Projekt "ROME"-Team hat ihre IOS- und Android-SDKs, neue Features wie die Aktivitäten des Benutzers und Umgestaltung Großteil ihres Codes, um eine einheitliche programmiererfahrung über die verschiedenen SDKs bieten überholt. [Alle neuen API-Referenz und Vorgehensweisen Dokumente](https://docs.microsoft.com/windows/project-rome/) werden während der Build 2018 Developer-Konferenz gerechnet.

### <a name="sets"></a>Gruppen

Die Funktion ist in Windows-Insider Preview-builds verfügbar. Wenn Sie die Funktion zu verwenden, wird Ihre app in einem Fenster gezeichnet, die mit anderen apps zu jeder app müssen eine eigene Registerkarte in der Titelleiste gemeinsam genutzt werden kann. 

## <a name="developer-guidance"></a>Anleitungen für Entwickler

### <a name="get-started"></a>Erste Schritte

Wir haben unsere Get revitalized Inhalte mit neuen Lernpfade gestartet. Diese neuen Themen darauf abzielen, bieten neue Windows 10-Entwickler mit Informationen über eine Reihe häufiger Aufgaben, dass sie möglicherweise ausführen möchten. Sie sind nicht Lernprogramme und tragbaren eine exemplarische Vorgehensweise nicht bereitstellen, sondern stattdessen zeigen, Dokumentation, in denen vorhanden ist und wie sie zu verwenden. Sehen Sie sich die überarbeitete [Programmieren](../get-started/create-uwp-apps.md) Seite, oder Lesen Sie jede einzelne Lernpfad:
...
![Abrufen von Schritte image](../get-started/images/build-your-app.png)
...
Windows kann jetzt Sie mehrere Instanzen von Ihrer UWP-app mit jeweils in eine eigene getrennten Prozess ausgeführt. [Das Video ansehen](https://www.youtube.com/watch?v=clnnf4cigd0&feature=youtu.be) , erfahren Sie, wie Sie eine neue app erstellen, die dieses Feature, dann [Lesen Sie die Entwicklerdokumentation](../launch-resume/multi-instance-uwp.md) für Weitere Hinweise zur Verwendung unterstützt und warum Sie dieses Feature verwenden.
