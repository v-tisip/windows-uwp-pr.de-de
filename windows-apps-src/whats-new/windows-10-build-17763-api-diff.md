...
Menüleiste <br> MenuBar.Items <br> MenuBar.itemsproperty <br> MenuBar.MenuBar
...
#### [<a name="panel"></a>Bereich](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.panel)
...
#### [<a name="tooltip"></a>QuickInfo](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)
...
#### [<a name="brush"></a>Pinsel](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
