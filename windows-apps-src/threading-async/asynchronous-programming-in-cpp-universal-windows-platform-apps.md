...
## <a name="consuming-an-async-operation-by-using-a-task"></a>Verwendung asynchroner Vorgänge mit Aufgaben
...
* [Visual C++-Programmiersprachenreferenz](https://msdn.microsoft.com/library/windows/apps/hh699871.aspx)
