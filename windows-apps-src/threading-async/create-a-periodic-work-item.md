...
> **Hinweis:** vermeiden Sie den Wert 0 (null) angeben (oder ein Wert kleiner als eine Millisekunde) für das Intervall. Andernfalls verhält sich der regelmäßige Timer wie ein einmaliger Timer.
