...
<span data-ttu-id="8bb75-104">[MakePri.exe](compile-resources-manually-with-makepri.md) akzeptiert die Befehle `createconfig`, `dump`, `new`, `resourcepack` und `versioned`.</span><span class="sxs-lookup"><span data-stu-id="8bb75-104">[MakePri.exe](compile-resources-manually-with-makepri.md) has the set of commands `createconfig`, `dump`, `new`, `resourcepack`, and `versioned`.</span></span> <span data-ttu-id="8bb75-105">In diesem Thema werden die Befehlszeilenoptionen für diese Befehle erläutert.</span><span class="sxs-lookup"><span data-stu-id="8bb75-105">This topic details the command-line options for their use.</span></span>

> [!NOTE]
> <span data-ttu-id="8bb75-106">MakePri.exe wird installiert, wenn Sie im **Windows SDK für verwalteten UWP-Apps** Option während der Installation von Windows Software Development Kit aktivieren.</span><span class="sxs-lookup"><span data-stu-id="8bb75-106">MakePri.exe is installed when you check the **Windows SDK for UWP Managed Apps** option while installing the Windows Software Development Kit.</span></span> <span data-ttu-id="8bb75-107">Es installiert ist, auf den Pfad `%WindowsSdkDir%bin\<WindowsTargetPlatformVersion>\x64\makepri.exe` (ebenso wie in den Ordnern für die anderen Architekturen).</span><span class="sxs-lookup"><span data-stu-id="8bb75-107">It is installed to the path `%WindowsSdkDir%bin\<WindowsTargetPlatformVersion>\x64\makepri.exe` (as well as in folders named for the other architectures).</span></span> <span data-ttu-id="8bb75-108">Beispiel: `C:\Program Files (x86)\Windows Kits\10\bin\10.0.17713.0\x64\makepri.exe`.</span><span class="sxs-lookup"><span data-stu-id="8bb75-108">For example, `C:\Program Files (x86)\Windows Kits\10\bin\10.0.17713.0\x64\makepri.exe`.</span></span>

## <a name="getting-help-from-the-command-line"></a><span data-ttu-id="8bb75-109">Hilfe von der Befehlszeile</span><span class="sxs-lookup"><span data-stu-id="8bb75-109">Getting help from the command-line</span></span>

<span data-ttu-id="8bb75-110">Sie können ausführen `MakePri.exe help` oder `MakePri.exe /?` um die Befehle anzuzeigen, die Sie mit MakePri.exe verwenden können.</span><span class="sxs-lookup"><span data-stu-id="8bb75-110">You can run `MakePri.exe help` or `MakePri.exe /?` to see the commands that you can use with MakePri.exe.</span></span> <span data-ttu-id="8bb75-111">Sie können auch ausstellen `MakePri.exe <command> /?` abgewartet Einzelheiten über einen Befehl und in sehr seltenen Fällen sogar `MakePri.exe <command> <option>` um Einzelheiten zu den Optionen finden Sie unter.</span><span class="sxs-lookup"><span data-stu-id="8bb75-111">You can also issue `MakePri.exe <command> /?` to see specifics about a command and, in very rare cases, even `MakePri.exe <command> <option>` to see specifics about an option.</span></span>
...
## <a name="createconfig-command"></a><span data-ttu-id="8bb75-113">Createconfig-Befehl</span><span class="sxs-lookup"><span data-stu-id="8bb75-113">Createconfig command</span></span>
...
## <a name="dump-command"></a><span data-ttu-id="8bb75-116">Dump-Befehl</span><span class="sxs-lookup"><span data-stu-id="8bb75-116">Dump command</span></span>

<span data-ttu-id="8bb75-117">Der Befehl `dump` gibt den Dump einer XML-Datei aus, die eine Liste aller Ressourcen in einer angegebenen PRI-Datei enthält.</span><span class="sxs-lookup"><span data-stu-id="8bb75-117">The `dump` command outputs a dumped xml file containing a list of all resources in a specified PRI file.</span></span> <span data-ttu-id="8bb75-118">Führen Sie `MakePri.exe dump /?` aus, um detaillierte Hilfe für diesen Befehl anzuzeigen.</span><span class="sxs-lookup"><span data-stu-id="8bb75-118">Run `MakePri.exe dump /?` to see detailed help for this command.</span></span>
...
## <a name="new-command"></a><span data-ttu-id="8bb75-122">New-Befehl</span><span class="sxs-lookup"><span data-stu-id="8bb75-122">New command</span></span>
...
## <a name="resourcepack-command"></a><span data-ttu-id="8bb75-125">ResourcePack-Befehl</span><span class="sxs-lookup"><span data-stu-id="8bb75-125">ResourcePack command</span></span>
...
## <a name="versioned-command"></a><span data-ttu-id="8bb75-129">Versioned-Befehl</span><span class="sxs-lookup"><span data-stu-id="8bb75-129">Versioned command</span></span>
...
## <a name="47extensiondllex"></a><span data-ttu-id="8bb75-132">&#47;ExtensionDll(ex)</span><span class="sxs-lookup"><span data-stu-id="8bb75-132">&#47;ExtensionDll(ex)</span></span>

<span data-ttu-id="8bb75-133">Verwenden Sie die Erweiterungs-DLL-Option (/ex) mit `createconfig`, `dump`, `new`, `resourcepack` und `versioned`, um den Speicherort der Umgebungserweiterungs-DLL für das Ressourcenverwaltungssystem festzulegen.</span><span class="sxs-lookup"><span data-stu-id="8bb75-133">You use the extension DLL option (/ex) with `createconfig`, `dump`, `new`, `resourcepack`, and `versioned` to specify the location of the Resource Management System environment extension DLL.</span></span>

## <a name="logging47metadata-file"></a><span data-ttu-id="8bb75-134">Logging&#47;Metadatendatei</span><span class="sxs-lookup"><span data-stu-id="8bb75-134">Logging&#47;metadata file</span></span>

<span data-ttu-id="8bb75-135">MakePri kann Informationen zu einem Ressourcenpaket in die Indexer-Metadatendatei einfügen.</span><span class="sxs-lookup"><span data-stu-id="8bb75-135">MakePri can include info specific to a resource pack in the indexer metadata file.</span></span> <span data-ttu-id="8bb75-136">Hier ein Beispiel einer Protokolldatei für `resources.pri` mit den PRI-Ressourcendateien `german.pri` und `highresolution.pri`:</span><span class="sxs-lookup"><span data-stu-id="8bb75-136">Here is an example of a log file for `resources.pri` with resource PRI files `german.pri` and `highresolution.pri`.</span></span>
...
## <a name="47indexfileif-option"></a><span data-ttu-id="8bb75-137">&#47;IndexFile(if) Option</span><span class="sxs-lookup"><span data-stu-id="8bb75-137">&#47;IndexFile(if) option</span></span>

<span data-ttu-id="8bb75-138">Verwenden Sie die Indexdateioption (/if) mit `dump`, `resourcepack` und `versioned`, um eine PRI-Eingabedatei anzugeben.</span><span class="sxs-lookup"><span data-stu-id="8bb75-138">You use the index file option (/if) with `dump`, `resourcepack`, and `versioned` to specify an input PRI file.</span></span>
...
<span data-ttu-id="8bb75-140">**FILEPATH** ist ein Token, das den Speicherort der PRI-Eingabedatei oder PRI-Schemadatei angibt</span><span class="sxs-lookup"><span data-stu-id="8bb75-140">**FILEPATH** is a token that that specifies the location of the input PRI file or PRI schema file.</span></span>

## <a name="47indexoptionsio-option"></a><span data-ttu-id="8bb75-141">& #47;IndexOptions(io)-Option</span><span class="sxs-lookup"><span data-stu-id="8bb75-141">&#47;IndexOptions(io) option</span></span>
...
<span data-ttu-id="8bb75-144">**Optionen** ist eine durch Trennzeichen getrennte Liste besteht aus der folgenden Optionen.</span><span class="sxs-lookup"><span data-stu-id="8bb75-144">**OPTIONS** is a comma-separated list comprised of the following options.</span></span>

- <span data-ttu-id="8bb75-145">+/-HiddenFiles(hf).</span><span class="sxs-lookup"><span data-stu-id="8bb75-145">+/-HiddenFiles(hf).</span></span> <span data-ttu-id="8bb75-146">Index (+) oder ignorieren (-) Dateien und Ordner ausgeblendet.</span><span class="sxs-lookup"><span data-stu-id="8bb75-146">Index (+) or ignore (-) hidden files and folders.</span></span>
- <span data-ttu-id="8bb75-147">+/-LinkedFiles(lf).</span><span class="sxs-lookup"><span data-stu-id="8bb75-147">+/-LinkedFiles(lf).</span></span> <span data-ttu-id="8bb75-148">Index (+) oder ignorieren (-) verknüpft, Dateien und Ordner.</span><span class="sxs-lookup"><span data-stu-id="8bb75-148">Index (+) or ignore (-) linked files and folders.</span></span>

## <a name="47mappingfilemf-option"></a><span data-ttu-id="8bb75-149">&#47;MappingFile(mf) Option</span><span class="sxs-lookup"><span data-stu-id="8bb75-149">&#47;MappingFile(mf) option</span></span>
...
## <a name="output-summary"></a><span data-ttu-id="8bb75-156">Ausgabezusammenfassung</span><span class="sxs-lookup"><span data-stu-id="8bb75-156">Output summary</span></span>
...
## <a name="47overwriteo-option"></a><span data-ttu-id="8bb75-159">&#47;Overwrite(o) Option</span><span class="sxs-lookup"><span data-stu-id="8bb75-159">&#47;Overwrite(o) option</span></span>
...
## <a name="47outputfileof-option"></a><span data-ttu-id="8bb75-161">&#47;OutputFile(of) Option</span><span class="sxs-lookup"><span data-stu-id="8bb75-161">&#47;OutputFile(of) option</span></span>

<span data-ttu-id="8bb75-162">Verwenden Sie die Ausgabedateioption (/of) mit `dump`, `new`, `resourcepack` und `versioned`, um den Ausgabespeicherort und den Namen der zu generierenden PRI-Datei anzugeben.</span><span class="sxs-lookup"><span data-stu-id="8bb75-162">You use the output file option (/of) with `dump`, `new`, `resourcepack`, and `versioned` to specify the output location and name of the PRI file to be generated.</span></span> <span data-ttu-id="8bb75-163">Sollte MakePri.exe mehrere PRI-Ressourcendateien generieren, werden diese im übergeordneten Ordner der Zieldatei abgelegt.</span><span class="sxs-lookup"><span data-stu-id="8bb75-163">If MakePri.exe generates more than one resource PRI file, it places them in the parent folder of the target file.</span></span> <span data-ttu-id="8bb75-164">Wenn Sie beispielsweise `/of MyParentFolder\TargetFile.pri` angeben, generiert MakePri.exe `TargetFile.language-en.pri` und `TargetFile.scale-100.pri` zusammen mit `TargetFile.pri` unter `ParentFolder`.</span><span class="sxs-lookup"><span data-stu-id="8bb75-164">For example, if you specify `/of MyParentFolder\TargetFile.pri` then MakePri.exe generates `TargetFile.language-en.pri` and `TargetFile.scale-100.pri` alongside `TargetFile.pri` under `ParentFolder`.</span></span>

<span data-ttu-id="8bb75-165">Hier ein Beispiel für eine Fehlerbedingung und die entsprechende Fehlermeldung:</span><span class="sxs-lookup"><span data-stu-id="8bb75-165">Here is an example error condition and the corresponding error message.</span></span>

| <span data-ttu-id="8bb75-166">Fehlerbedingung</span><span class="sxs-lookup"><span data-stu-id="8bb75-166">Error condition</span></span> | <span data-ttu-id="8bb75-167">Fehlermeldung</span><span class="sxs-lookup"><span data-stu-id="8bb75-167">Error message</span></span> |
| --------------- | ------------- |
| <span data-ttu-id="8bb75-168">Der Name der Ausgabedatei entspricht einem der Ressourcenpaketnamen in der Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="8bb75-168">The output file name is the same as one of the resource pack names in the configuration.</span></span> | <span data-ttu-id="8bb75-169">Ungültige Konfiguration: Der Ressourcenpaketname <resource pack name> darf nicht mit dem Namen der Ausgabedatei <outputfilename.pri> übereinstimmen.</span><span class="sxs-lookup"><span data-stu-id="8bb75-169">Invalid Configuration: Resource Pack name <resource pack name> cannot be the same as the output file <outputfilename.pri>.</span></span> |

## <a name="reversemaprm-option"></a><span data-ttu-id="8bb75-170">/ReverseMap(rm) Option</span><span class="sxs-lookup"><span data-stu-id="8bb75-170">/ReverseMap(rm) option</span></span>

<span data-ttu-id="8bb75-171">Sie können die Option zum Umkehren der Zuordnung (/rm) mit `new`, `resourcepack` und `versioned` verwenden, um in der PRI-Datei einen Abschnitt mit umgekehrter Zuordnung zu generieren, der zum Debuggen verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="8bb75-171">You use the reverse map option (/rm) with `new`, `resourcepack`, and `versioned` to generate a reverse-mapping section in the PRI file, which can be used for debugging.</span></span>

## <a name="47schemafilesf-option"></a><span data-ttu-id="8bb75-172">&#47;SchemaFile(sf) Option</span><span class="sxs-lookup"><span data-stu-id="8bb75-172">&#47;SchemaFile(sf) option</span></span>

<span data-ttu-id="8bb75-173">Verwenden Sie die Schemadateioption (/sf) mit `new`, `resourcepack` und `versioned`, um eine Schemadatei am angegebenen Speicherort zu schreiben.</span><span class="sxs-lookup"><span data-stu-id="8bb75-173">You use the schema file option (/sf) with `new`, `resourcepack`, and `versioned` to write a schema file at the specified location.</span></span>
...
<span data-ttu-id="8bb75-175">**FILEPATH** ist ein Token, das angibt, an welchem Speicherort die Schemadatei geschrieben werden soll.</span><span class="sxs-lookup"><span data-stu-id="8bb75-175">**FILEPATH** is a token that that specifies where to write the schema file.</span></span>

<span data-ttu-id="8bb75-176">Hier ein Beispiel für eine Datendatei:</span><span class="sxs-lookup"><span data-stu-id="8bb75-176">This is an example of a schema file.</span></span>
...
## <a name="47versionmajorvma-is-deprecated"></a><span data-ttu-id="8bb75-177">&#47;VersionMajor(vma) ist veraltet</span><span class="sxs-lookup"><span data-stu-id="8bb75-177">&#47;VersionMajor(vma) is deprecated</span></span>
...
<span data-ttu-id="8bb75-179">Verwenden Sie stattdessen in Ihrer Konfigurationsdatei das Attribut [resources@majorVersion](makepri-exe-configuration.md), um die Hauptversionsnummer anzugeben.</span><span class="sxs-lookup"><span data-stu-id="8bb75-179">To provide the major version number, use the [resources@majorVersion](makepri-exe-configuration.md) attribute in your configuration file.</span></span>

## <a name="related-topics"></a><span data-ttu-id="8bb75-180">Verwandte Themen</span><span class="sxs-lookup"><span data-stu-id="8bb75-180">Related topics</span></span>

* [<span data-ttu-id="8bb75-181">MakePri.exe</span><span class="sxs-lookup"><span data-stu-id="8bb75-181">MakePri.exe</span></span>](compile-resources-manually-with-makepri.md)
