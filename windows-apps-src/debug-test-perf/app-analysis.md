...
#### <a name="image-is-not-being-set-asynchronously"></a>Bild wird nicht asynchron festgelegt
...
## <a name="binding-is-being-used-instead-of-xbind"></a>{Binding} wird anstelle von {x:Bind} verwendet
