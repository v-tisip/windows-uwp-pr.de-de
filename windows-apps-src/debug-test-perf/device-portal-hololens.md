...
> [!IMPORTANT]
> Wenn Ihr PC das Gerät nicht finden kann, versuchen Sie es mit realen Netzwerk IP-Adresse des HoloLens-Gerät statt `http://127.0.0.1:10080`.
