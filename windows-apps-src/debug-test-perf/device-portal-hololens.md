...
> [!IMPORTANT]
> Wenn Ihr PC das Gerät nicht finden kann, versuchen Sie es mit der echten Netzwerk IP-Adresse der HoloLens-Gerät statt `http://127.0.0.1:10080`.
