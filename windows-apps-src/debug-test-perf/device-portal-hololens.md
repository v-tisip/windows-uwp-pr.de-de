...
> [!IMPORTANT]
> Wenn Ihr PC Gerät gefunden werden kann, verwenden Sie die tatsächliche Netzwerk IP-Adresse der HoloLens-Gerät, statt `http://127.0.0.1:10080`.
