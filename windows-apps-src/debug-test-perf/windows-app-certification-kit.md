...
-   Sie müssen [Zertifizierungskit für Windows-App-Version 10]( http://go.microsoft.com/fwlink/p/?LinkID=309666), installieren, die in Windows Software Development Kit (SDK) für Windows 10 enthalten ist.
