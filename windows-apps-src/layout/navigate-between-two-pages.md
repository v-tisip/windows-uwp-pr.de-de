...
Fügen Sie der Benutzeroberfläche von „Page1.xaml“ folgenden Inhalt hinzu.
...
Fügen Sie der `Page2`-Klasse in der CodeBehind-Datei „Page2.xaml“ den folgenden Code hinzu, um das `Click`-Ereignis des zuvor hinzugefügten [**HyperlinkButton**](https://msdn.microsoft.com/library/windows/apps/br242739)-Elements zu behandeln. Nun wird die Navigation zu „Page1.xaml“ ausgeführt.
