# [Erste Schritte mit der universellen Windows-Plattform](https://developer.microsoft.com/windows/apps/getstarted)
...
### [Point of Service (POS)](devices-sensors/point-of-service.md)
...
##### [Abrufen von Antwortinformationen für App-Rezensionen](monetize/get-response-info-for-app-reviews.md)
##### [Senden von Antworten auf App-Rezensionen](monetize/submit-responses-to-app-reviews.md)
...
##### [Verwalten von Lieferpositionen für Anzeigenkampagnen](monetize/manage-delivery-lines-for-ad-campaigns.md)
##### [Verwalten von Zielgruppenprofilen für Anzeigenkampagnen](monetize/manage-targeting-profiles-for-ad-campaigns.md)
##### [Verwalten von Werbemitteln für Anzeigenkampagnen](monetize/manage-creatives-for-ad-campaigns.md)
...
### [Erstellen von Zertifikaten für die Paketsignatur](packaging/create-certificate-package-signing.md)
...
#### [Handbuch Verpacken Desktop-Brücke für.NET Desktop-Apps mit Visual Studio](porting/desktop-to-uwp-packaging-dot-net.md)
...
## [Neues bei Windows 10 für Entwickler](whats-new/windows-10-creators-preview.md)
### [Neuigkeiten in Windows 10, Version 1607](whats-new/windows-10-version-1607.md)
...
### [Bericht „Installationen“](publish/installs-report.md)
...
### [Bericht zur Partneranzeigen-Performance](publish/affiliates-performance-report.md)
### [Bericht „Bewerben Ihrer App“](publish/promote-your-app-report.md)
...
### [Senden benutzerorientierter Pushbenachrichtigungen an die Kunden Ihrer App](publish/send-push-notifications-to-your-apps-customers.md)
