...
description: "In den meisten Spielen werden irgendwann Ressourcen und Objekte (wie Shader, Texturen, vordefinierte Gitter oder andere Grafikdaten) aus dem lokalen Speicher oder über einen anderen Datenstrom geladen."
