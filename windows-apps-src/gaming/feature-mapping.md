...
## <a name="move-shader-programs-from-fx-to-hlsl"></a><span data-ttu-id="ccb9c-136">Umstellung von Shaderprogrammen von FX auf HLSL</span><span class="sxs-lookup"><span data-stu-id="ccb9c-136">Move shader programs from FX to HLSL</span></span>
...
## <a name="use-microsoft-media-foundation-instead-of-directshow"></a><span data-ttu-id="ccb9c-161">Verwenden von Microsoft Media Foundation anstelle von DirectShow</span><span class="sxs-lookup"><span data-stu-id="ccb9c-161">Use Microsoft Media Foundation instead of DirectShow</span></span>
...
-   [<span data-ttu-id="ccb9c-175">Verbinden mit Sockets (UWP-Apps mit C#/VB/C++ und XAML) (Windows)</span><span class="sxs-lookup"><span data-stu-id="ccb9c-175">Connecting with sockets (UWP apps using C#/VB/C++ and XAML) (Windows)</span></span>](https://msdn.microsoft.com/library/windows/apps/xaml/hh452976)
...
<p><a href="https://msdn.microsoft.com/library/windows/desktop/ff476635"><span data-ttu-id="ccb9c-206">ID3D11Texture2D</span><span class="sxs-lookup"><span data-stu-id="ccb9c-206">ID3D11Texture2D</span></span></a></p>
...
<p><a href="https://msdn.microsoft.com/library/windows/desktop/bb174371"><span data-ttu-id="ccb9c-224">IDirect3DDevice9::DrawPrimitive</span><span class="sxs-lookup"><span data-stu-id="ccb9c-224">IDirect3DDevice9::DrawPrimitive</span></span></a></p></td>
...
<td align="left"><p><span data-ttu-id="ccb9c-273">DXGI_FORMAT_B8G8R8X8_UNORM</span><span class="sxs-lookup"><span data-stu-id="ccb9c-273">DXGI_FORMAT_B8G8R8X8_UNORM</span></span></p>
...
<p><span data-ttu-id="ccb9c-295">DXGI_FORMAT_R8G8B8A8_UNORM_SRGB</span><span class="sxs-lookup"><span data-stu-id="ccb9c-295">DXGI_FORMAT_R8G8B8A8_UNORM_SRGB</span></span></p></td>
</tr>
<tr class="odd">
...
<td align="left"><p><span data-ttu-id="ccb9c-329">Nicht verfügbar</span><span class="sxs-lookup"><span data-stu-id="ccb9c-329">Not available</span></span></p></td>
</tr>
<tr class="odd">
...
<td align="left"><p><span data-ttu-id="ccb9c-361">Nicht verfügbar</span><span class="sxs-lookup"><span data-stu-id="ccb9c-361">Not available</span></span></p></td>
</tr>
<tr class="even">
...
<strong>Hinweis:</strong>  verwenden .r Swizzle im Shader, um Rot für andere Komponenten zu D3D9-Verhaltens den swizzle duplizieren.</span><span class="sxs-lookup"><span data-stu-id="ccb9c-382">
...
<tr class="odd">
<td align="left"><p><span data-ttu-id="ccb9c-401">D3DFMT_A32B32G32R32F</span><span class="sxs-lookup"><span data-stu-id="ccb9c-401">D3DFMT_A32B32G32R32F</span></span></p></td>
...
<td align="left"><p><span data-ttu-id="ccb9c-422">DXGI_FORMAT_R16G16B16A16_SINT</span><span class="sxs-lookup"><span data-stu-id="ccb9c-422">DXGI_FORMAT_R16G16B16A16_SINT</span></span></p>
<div class="alert"><span data-ttu-id="ccb9c-423">
<strong>Hinweis:</strong>  der Shader ruft SINT-Werte ab, aber wenn ganzzahlige Direct3D 9-Gleitkommawerte benötigt werden, St. gerade konvertiert werden kann einfach in float32 im Shader.</span><span class="sxs-lookup"><span data-stu-id="ccb9c-423">
<strong>Note</strong> The shader gets SINT values, but if Direct3D 9 style integral floats are needed, SINT can just be converted to float32 in the shader.</span></span>
</div>
<div>
 
...
<tr class="odd">
<td align="left"><p><span data-ttu-id="ccb9c-424">D3DDECLTYPE_UBYTE4N</span><span class="sxs-lookup"><span data-stu-id="ccb9c-424">D3DDECLTYPE_UBYTE4N</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-425">DXGI_FORMAT_R8G8B8A8_UNORM</span><span class="sxs-lookup"><span data-stu-id="ccb9c-425">DXGI_FORMAT_R8G8B8A8_UNORM</span></span></p></td>
</tr>
<tr class="even">
<td align="left"><p><span data-ttu-id="ccb9c-426">D3DDECLTYPE_SHORT2N</span><span class="sxs-lookup"><span data-stu-id="ccb9c-426">D3DDECLTYPE_SHORT2N</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-427">DXGI_FORMAT_R16G16_SNORM</span><span class="sxs-lookup"><span data-stu-id="ccb9c-427">DXGI_FORMAT_R16G16_SNORM</span></span></p></td>
</tr>
<tr class="odd">
<td align="left"><p><span data-ttu-id="ccb9c-428">D3DDECLTYPE_SHORT4N</span><span class="sxs-lookup"><span data-stu-id="ccb9c-428">D3DDECLTYPE_SHORT4N</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-429">DXGI_FORMAT_R16G16B16A16_SNORM</span><span class="sxs-lookup"><span data-stu-id="ccb9c-429">DXGI_FORMAT_R16G16B16A16_SNORM</span></span></p></td>
</tr>
<tr class="even">
<td align="left"><p><span data-ttu-id="ccb9c-430">D3DDECLTYPE_USHORT2N</span><span class="sxs-lookup"><span data-stu-id="ccb9c-430">D3DDECLTYPE_USHORT2N</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-431">DXGI_FORMAT_R16G16_UNORM</span><span class="sxs-lookup"><span data-stu-id="ccb9c-431">DXGI_FORMAT_R16G16_UNORM</span></span></p></td>
</tr>
<tr class="odd">
<td align="left"><p><span data-ttu-id="ccb9c-432">D3DDECLTYPE_USHORT4N</span><span class="sxs-lookup"><span data-stu-id="ccb9c-432">D3DDECLTYPE_USHORT4N</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-433">DXGI_FORMAT_R16G16B16A16_UNORM</span><span class="sxs-lookup"><span data-stu-id="ccb9c-433">DXGI_FORMAT_R16G16B16A16_UNORM</span></span></p></td>
</tr>
<tr class="even">
<td align="left"><p><span data-ttu-id="ccb9c-434">D3DDECLTYPE_UDEC3</span><span class="sxs-lookup"><span data-stu-id="ccb9c-434">D3DDECLTYPE_UDEC3</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-435">Nicht verfügbar</span><span class="sxs-lookup"><span data-stu-id="ccb9c-435">Not available</span></span></p></td>
</tr>
<tr class="odd">
<td align="left"><p><span data-ttu-id="ccb9c-436">D3DDECLTYPE_DEC3N</span><span class="sxs-lookup"><span data-stu-id="ccb9c-436">D3DDECLTYPE_DEC3N</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-437">Nicht verfügbar</span><span class="sxs-lookup"><span data-stu-id="ccb9c-437">Not available</span></span></p></td>
</tr>
<tr class="even">
<td align="left"><p><span data-ttu-id="ccb9c-438">D3DDECLTYPE_FLOAT16_2</span><span class="sxs-lookup"><span data-stu-id="ccb9c-438">D3DDECLTYPE_FLOAT16_2</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-439">DXGI_FORMAT_R16G16_FLOAT</span><span class="sxs-lookup"><span data-stu-id="ccb9c-439">DXGI_FORMAT_R16G16_FLOAT</span></span></p></td>
</tr>
<tr class="odd">
<td align="left"><p><span data-ttu-id="ccb9c-440">D3DDECLTYPE_FLOAT16_4</span><span class="sxs-lookup"><span data-stu-id="ccb9c-440">D3DDECLTYPE_FLOAT16_4</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-441">DXGI_FORMAT_R16G16B16A16_FLOAT</span><span class="sxs-lookup"><span data-stu-id="ccb9c-441">DXGI_FORMAT_R16G16B16A16_FLOAT</span></span></p></td>
</tr>
<tr class="even">
<td align="left"><p><span data-ttu-id="ccb9c-442">FourCC 'ATI1'</span><span class="sxs-lookup"><span data-stu-id="ccb9c-442">FourCC 'ATI1'</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-443">DXGI_FORMAT_BC4_UNORM</span><span class="sxs-lookup"><span data-stu-id="ccb9c-443">DXGI_FORMAT_BC4_UNORM</span></span></p>
<div class="alert"><span data-ttu-id="ccb9c-444">
<strong>Hinweis:</strong>  erfordert Funktionsebene 10.0 oder höher</span><span class="sxs-lookup"><span data-stu-id="ccb9c-444">
...
<tr class="odd">
<td align="left"><p><span data-ttu-id="ccb9c-445">FourCC 'ATI2'</span><span class="sxs-lookup"><span data-stu-id="ccb9c-445">FourCC 'ATI2'</span></span></p></td>
<td align="left"><p><span data-ttu-id="ccb9c-446">DXGI_FORMAT_BC5_UNORM</span><span class="sxs-lookup"><span data-stu-id="ccb9c-446">DXGI_FORMAT_BC5_UNORM</span></span></p>
<div class="alert"><span data-ttu-id="ccb9c-447">
<strong>Hinweis:</strong>  erfordert Funktionsebene 10.0 oder höher</span><span class="sxs-lookup"><span data-stu-id="ccb9c-447">
<strong>Note</strong> Requires Feature Level 10.0 or later</span></span>
</div>
<div>
 
