...
<table>
    ...
    <tr>
        ...
        <td>[Entwickeln von Windows-Apps](https://dev.windows.com/develop)</td>
    </tr>
    <tr>
        <td>Entwicklung von UWP-Apps (Universelle Windows-Plattform)</td>
        <td>[Anleitungen für Windows 10-Apps](https://msdn.microsoft.com/library/windows/apps/mt244352)</td>
    </tr>
    <tr>
        <td>Anleitungen für UWP-Spiele</td>
        <td>[Spiele und DirectX](index.md) </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Xbox One XDK-Dokumentation](https://developer.xboxlive.com/en-us/platform/development/documentation/Pages/home.aspx)</td>
    </tr>
    <tr>
        <td>Xbox One-Whitepapers für Entwickler (GDN)</td>
...
<table>
    ...
    <tr>
        ...
        <td>[Unabhängiges Entwicklerprogramm für Xbox One](http://go.microsoft.com/fwlink/p/?LinkID=526271)</td>
    </tr>
    <tr>
        <td>ID@Xbox-Endbenutzerwebsite</td>
...
<table>
    ...
    <tr>
        ...
        <td>[Erstellen eines einfachen UWP-Spiels mit DirectX](tutorial--create-your-first-metro-style-directx-game.md)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Beispiele für Xbox One-Spiele (GDN)</td>
        <td>[Beispiele](https://developer.xboxlive.com/en-us/platform/development/education/Pages/Samples.aspx)</td>
    </tr>
    <tr>
        <td>Beispiele für Windows 8-Spiele (MSDN Code Gallery)</td>
        <td>[Beispiele für Windows Store-Spiele](https://code.msdn.microsoft.com/windowsapps/site/search?f%5B0%5D.Type=SearchText&f%5B0%5D.Value=game&f%5B1%5D.Type=Contributors&f%5B1%5D.Value=Microsoft&f%5B1%5D.Text=Microsoft)</td>
    </tr>
    <tr>
        <td>Beispiel für ein Spiel mit JavaScript und HTML5</td>
        <td>[Beispiel für ein Spiel mit JavaScript, HTML5 und Toucheingabe](https://code.msdn.microsoft.com/windowsapps/JavaScript-and-HTML5-touch-d96f6031)</td>
    </tr>      
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Foren für Windows Store und Apps](https://social.msdn.microsoft.com/Forums/home?category=windowsapps)</td>
    </tr>
    <tr>
        <td>Entwicklerforum für UWP-Apps</td>
        <td>[Entwicklung von UWP-Apps (Apps für die Universelle Windows-Plattform)](https://social.msdn.microsoft.com/Forums/home?forum=wpdevelop)</td>
    </tr>

    <tr>
        <td>Entwicklerforen für Desktopanwendungen</td>
        <td>[Foren für Windows-Desktopanwendungen](https://social.msdn.microsoft.com/Forums/home?category=windowsdesktopdev)</td>
    </tr>
    <tr>
        <td>Windows Store-Spiele mit DirectX (archivierte Forenbeiträge)</td>
        <td>[Erstellen von Windows Store-Spielen mit DirectX (archiviert)](https://social.msdn.microsoft.com/Forums/vstudio/home?forum=wingameswithdirectx)</td>
    </tr>
    <tr>
        <td>Windows 10-Entwicklerforen für verwaltete Partner</td>
        <td>[Xbox-Entwicklerforen: Windows 10](http://aka.ms/win10devforums)</td>
    </tr>
    <tr>
        <td>Foren zum Early Access-Programm für DirectX</td>
...
<table>
    ...
    <tr>
        ...
        <td>[Beiträge in Windows 10](http://blogs.windows.com/blog/tag/windows-10/)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>[Spieletechnologien für UWP-Apps](game-development-platform-guide.md)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Entwickeln von Spielen für Windows 10](http://channel9.msdn.com/Events/GDC/GDC-2015/Developing-Games-for-Windows-10)</td>
    </tr>
    <tr>
        <td>Spielerlebnis unter Windows 10 (Video)</td>
        <td>[Spielerfahrung von Endbenutzern unter Windows 10](http://channel9.msdn.com/Events/GDC/GDC-2015/Gaming-Consumer-Experience-on-Windows-10)</td>
    </tr>
    <tr>
        <td>Übergreifendes Spielen im gesamten Microsoft-Ökosystem (Video)</td>
        <td>[Die Zukunft des Spielens im gesamten Microsoft-Ökosystem](http://channel9.msdn.com/Events/GDC/GDC-2015/The-Future-of-Gaming-Across-the-Microsoft-Ecosystem)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Barrierefreiheit von Spielen](https://msdn.microsoft.com/windows/uwp/gaming/accessibility-for-games)</td>
    </tr>
    <tr>
        <td>Erstellen von Spielen mit der Cloud</td>
        <td>[Cloud für Spiele](https://msdn.microsoft.com/windows/uwp/gaming/cloud-for-games)</td>
    </tr>
    <tr>
        <td>Monetisierung eines Spiels</td>
        <td>[Monetarisierung von Spielen](https://msdn.microsoft.com/windows/uwp/gaming/monetization-for-games)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Anleitungen für DirectX-Spiele</td>
        <td>[Spiele und DirectX](index.md)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Direct3D 12-Grafiken](https://msdn.microsoft.com/library/windows/desktop/dn903821)</td>
    </tr>
    <tr>
        <td>Videos zu Grafiken und zur DirectX 12-Entwicklung (YouTube-Kanal)</td>
        <td>[Informationen zu Microsoft DirectX 12 und Grafiken](https://www.youtube.com/channel/UCiaX2B8XiXR70jaN7NK-FpA)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[XAML-Plattform](https://msdn.microsoft.com/library/windows/apps/mt228259)</td>
    </tr>
    <tr>
        <td>XAML-UI und -Steuerelemente</td>
        <td>[Steuerelemente, Layouts und Text](https://msdn.microsoft.com/library/windows/apps/mt228348)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[HTML- und DOM-Referenz](https://msdn.microsoft.com/library/windows/apps/br212882.aspx)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>[Interoperabilität von DirectX und XAML](directx-and-xaml-interop.md)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Visual C++-Programmiersprachenreferenz (C++/CX)](https://msdn.microsoft.com/library/windows/apps/hh699871.aspx)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>[C#-Programmiersprachenreferenz](https://msdn.microsoft.com/library/kx37x362.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[JavaScript-Referenz](https://msdn.microsoft.com/library/windows/apps/jj613794)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Was ist Direct3D 12?](https://msdn.microsoft.com/library/windows/desktop/dn899228)</td>
    </tr>
    <tr>
        <td>Übersicht über Direct3D 11</td>
        <td>[Direct3D 11-Grafik](https://msdn.microsoft.com/library/windows/desktop/ff476080)</td>
    </tr>
    <tr>
...
Mithilfe von Brücken, Spielengines und Middleware können Sie je nach Spiel unter Umständen die Entwicklung und das Testing beschleunigen und den damit verbundenen Ressourcenaufwand verringern. Anhand der folgenden Übersicht und Ressourcen für Brücken, Spielengines und Middleware können Sie ermitteln, ob etwas für Sie dabei ist.
...
<table>
    ...
    <tr>
        <td>Brücken und Spielengines für Windows 10 (Blogbeitrag)</td>
        <td>[Weitere Möglichkeiten, um Ihren Code für den schnell wachsenden Windows 10-Store zu portieren](http://blogs.windows.com/buildingapps/2015/09/17/more-ways-to-bring-your-code-to-fast-growing-windows-10-store/)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Was ist Middleware für die Spieleentwicklung? Brauche ich das?](http://blogs.msdn.com/b/wsdevsol/archive/2014/05/02/game-development-middleware-what-is-it-do-i-need-it.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>UWP Brücken</td>
        <td>[Portieren Ihres Codes für Windows](https://dev.windows.com/bridges/)</td>
    </tr>
    <tr>
...
Unity 5 stellt die nächste Generation der preisgekrönten Entwicklungsplattform zur Erstellung von 2D- und 3D-Spielen und interaktiven Benutzeroberflächen dar. Die Lösung zeichnet sich durch neue künstlerische Möglichkeiten, verbesserte Grafikfunktionen und eine höhere Effizienz aus.

DirectX 12-Unterstützung wird laut [Unity-Roadmap](https://unity3d.com/unity/roadmap) in einer späteren Version von Unity eingeführt.
...
<table>
    ...
    <tr>
        ...
        <td>[Unity – Spielengine](http://unity3d.com/)</td>
    </tr>
    <tr>
        <td>Unity 5 herunterladen</td>
        <td>[Unity herunterladen](http://unity3d.com/get-unity)</td>
    </tr>
    <tr>
        <td>Unterstützung von UWP-Apps (Universelle Windows-Plattform) in Unity 5.2 (Blogbeitrag)</td>
        <td>[Windows 10-Apps für Universelle Windows-Plattform in Unity 5.2](http://blogs.unity3d.com/2015/09/09/windows-10-universal-apps-in-unity-5-2/)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Portierungsleitfaden](https://unity3d.com/partners/microsoft/porting-guides)</td>
    </tr>
    <tr>
        <td>Veröffentlichen eines Unity-Spiels als UWP-App (Universelle Windows-Plattform) (Video)</td>
        <td>[So veröffentlichen Sie Ihr Unity-Spiel als UWP-App](https://channel9.msdn.com/Blogs/One-Dev-Minute/How-to-publish-your-Unity-game-as-a-UWP-app)</td>
    </tr>
    <tr>
        <td>Verwenden von Unity zum Erstellen von Windows-Spielen und -Apps (Video)</td>
        <td>[Erstellen von Windows-Spielen und -Apps mit Unity](https://channel9.msdn.com/Blogs/One-Dev-Minute/Making-games-and-apps-with-Unity)</td>
    </tr>
    <tr>
        <td>Unity-Spielentwicklung mit Visual Studio (Videoserie)</td>
        <td>[Verwendung von Unity mit Visual Studio 2015](http://go.microsoft.com/fwlink/?LinkId=722359)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Cocos2d-X</td>
        <td>[Was ist Cocos2d-X?](http://www.cocos2d-x.org/)</td>
    </tr>
    <tr>
        <td>Cocos2d-X-Programmieranleitung</td>
        <td>[Cocos2d-X-Programmieranleitung v3.8](http://www.cocos2d-x.org/programmersguide/)</td>
    </tr>
    <tr>
        <td>Cocos2d-X unter Windows 10 (Blogbeitrag)</td>
        <td>[Ausführen von Cocos2d-X unter Windows 10](https://blogs.windows.com/buildingapps/2015/06/15/running-cocos2d-x-on-windows-10/)</td>
    </tr>
    <tr>
        <td>Windows Store-Spiele mit Cocos2d-X (Video)</td>
        <td>[Erstellen eines Spiels für Windows-Geräte mit Cocos2d-X](http://www.microsoftvirtualacademy.com/training-courses/build-a-game-with-cocos2d-x-for-windows-devices)</td>
    </tr>
</table>
...
### <a name="middleware-and-partners"></a>Middleware und Partner

Es gibt noch viele weitere Middleware- und Engine-Partner, die Sie ggf. mit Lösungen für Ihre individuellen Anforderungen bei der Spieleentwicklung unterstützen können.
...
<table>
    ...
    <tr>
        ...
        <td>[Dev Center-Partner](https://developer.microsoft.com/windows/app-middleware-partners)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Wechsel von Windows-Runtime 8.x zu UWP](https://msdn.microsoft.com/library/windows/apps/mt238322)</td>
    </tr>
    <tr>
        <td>Portieren einer Windows 8-App zu einer UWP-App (Universelle Windows-Plattform) (Video)</td>
        <td>[Portieren von Windows 8.1-Apps zu Windows 10](https://channel9.msdn.com/Series/A-Developers-Guide-to-Windows-10/21)</td>
    </tr>
    <tr>
        <td>Portieren einer iOS-App zu einer UWP-App (Universelle Windows-Plattform)</td>
        <td>[Wechsel von iOS zu UWP](https://msdn.microsoft.com/library/windows/apps/mt238320)</td>
    </tr>
    <tr>
        <td>Portieren einer Silverlight-App zu einer UWP-App (Universelle Windows-Plattform)</td>
        <td>[Wechsel von Windows Phone Silverlight zu UWP](https://msdn.microsoft.com/library/windows/apps/mt238323)</td>
    </tr>
    <tr>
        <td>Portieren von XAML oder Silverlight zu einer UWP-App (Universelle Windows-Plattform) (Video)</td>
        <td>[Portieren einer App von XAML oder Silverlight zu Windows 10](https://channel9.msdn.com/Events/Build/2015/3-741)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Portieren von DirectX 9 zur universellen Windows-Plattform (UWP)](porting-your-directx-9-game-to-windows-store.md)</td>
    </tr>
    <tr>
        <td>Portieren von Direct3D 11 zu Direct3D 12</td>
        <td>[Portieren von Direct3D 11 zu Direct3D 12](https://msdn.microsoft.com/library/windows/desktop/mt431709)</td>
    </tr>
    <tr>
        <td>Portieren von OpenGL ES zu Direct3D 11</td>
        <td>[Portieren von OpenGL ES 2.0 zu Direct3D 11](port-from-opengl-es-2-0-to-directx-11-1.md)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Alternativen zu Windows-APIs in Apps für die Universelle Windows-Plattform (UWP)](https://msdn.microsoft.com/library/windows/apps/hh464945)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Was ist eine UWP-App (Universelle Windows-Plattform)?](https://msdn.microsoft.com/library/windows/apps/dn726767)</td>
    </tr>
    <tr>
        <td>Übersicht über die UWP</td>
        <td>[Anleitung für UWP-Apps](https://msdn.microsoft.com/library/windows/apps/dn894631)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Erste Schritte mit Windows-Apps](https://dev.windows.com/getstarted)</td>
    </tr>
    <tr>
        <td>Vorbereitung auf die UWP-Entwicklung</td>
        <td>[Vorbereitung](https://msdn.microsoft.com/library/windows/apps/dn726766)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Windows 10-Entwicklung für Neueinsteiger](https://channel9.msdn.com/Series/Windows-10-development-for-absolute-beginners)</td>
    </tr>
    <tr>
        <td>Ankündigung der Windows 10-Neueinsteigerserie mit XAML (Blogbeitrag)</td>
        <td>[Windows 10-Entwicklung für Neueinsteiger](http://blogs.windows.com/buildingapps/2015/09/30/windows-10-development-for-absolute-beginners/)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Netzwerk und Webdienste](https://msdn.microsoft.com/library/windows/apps/mt280378)</td>
    </tr>
    <tr>
        <td>Verwenden von „Windows.Web.HTTP“ und „Windows.Networking.Sockets“ in Spielen</td>
        <td>[Netzwerkfunktionen für Spiele](work-with-networking-in-your-directx-game.md)</td>
    </tr>
    <tr>
        <td>Asynchrone Programmierkonzepte für UWP</td>
        <td>[Asynchrone Programmierung](https://msdn.microsoft.com/library/windows/apps/mt187335)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Nicht unterstützte CRT-Funktionen in Apps für die universelle Windows-Plattform](https://msdn.microsoft.com/library/windows/apps/jj606124.aspx)</td>
    </tr>
    <tr>
        <td>Alternativen zu Windows-APIs</td>
        <td>[Alternativen zu Windows-APIs in Apps für die universelle Windows-Plattform (UWP)](https://msdn.microsoft.com/library/windows/apps/mt592894.aspx)</td>
    </tr>
</table>
...
Die Prozesslebensdauer-Verwaltung (bzw. der App-Lebenszyklus) beschreibt die verschiedenen Aktivierungszustände, die eine UWP-App (Universelle Windows-Plattform) durchlaufen kann. Ihr Spiel kann aktiviert, angehalten, fortgesetzt oder beendet werden und diese Zustände auf unterschiedliche Arten durchlaufen.
...
<table>
    ...
    <tr>
        ...
        <td>[App-Lebenszyklus](https://msdn.microsoft.com/library/windows/apps/mt243287)</td>
    </tr>
    <tr>
        <td>Auslösen von App-Übergängen mithilfe von Microsoft Visual Studio</td>
        <td>[So wird's gemacht: Auslösen von Anhalte-, Fortsetzungs- und Hintergrundereignissen für Windows Store-Apps in Visual Studio](https://msdn.microsoft.com/library/hh974425.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Gestalten von UWP-Apps](https://dev.windows.com/design)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Entwerfen von Spielen für eine Windows Core-Welt](http://channel9.msdn.com/Events/GDC/GDC-2015/Designing-Games-for-a-Windows-Core-World)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Farbhandbuch</td>
        <td>[Bewährte Methoden: Farbe](https://assets.windowsphone.com/499cd2be-64ed-4b05-a4f5-cd0c9ad3f6a3/101_BestPractices_Color_InvariantCulture_Default.zip)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Bewährte Methoden: Typografie](http://go.microsoft.com/fwlink/?LinkId=535007)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Entwicklung von DirectX-Spielen auf der UWP</td>
        <td>[Spiele und DirectX](index.md)</td>
    </tr>
    <tr>
        <td>DirectX-Interaktionen mit dem UWP-App-Modell</td>
        <td>[Das App-Objekt und DirectX](about-the-metro-style-user-interface-and-directx.md)</td>
    </tr>
    <tr>
        <td>Videos zu Grafiken und zur DirectX 12-Entwicklung (YouTube-Kanal)</td>
        <td>[Informationen zu Microsoft DirectX 12 und Grafiken](https://www.youtube.com/channel/UCiaX2B8XiXR70jaN7NK-FpA)</td>
    ...
    <tr>
        ...
        <td>[Bessere Leistung und Performance: Ihr Spiel unter DirectX 12](http://channel9.msdn.com/Events/GDC/GDC-2015/Better-Power-Better-Performance-Your-Game-on-DirectX12)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Einrichtung der Direct3D 12 Programmierungsumgebung](https://msdn.microsoft.com/library/windows/desktop/dn899120.aspx)</td>
    </tr>
    <tr>
        <td>Erstellen einer Grundkomponente</td>
        <td>[Erstellen einer einfachen Direct3D 12-Komponente](https://msdn.microsoft.com/library/windows/desktop/dn859356.aspx)</td>
    </tr>
    <tr>
        <td>Änderungen in Direct3D 12</td>
        <td>[Wichtige Änderungen bei der Migration von Direct3D 11 zu Direct3D 12](https://msdn.microsoft.com/library/windows/desktop/dn899194.aspx)</td>
    </tr>
    <tr>
        <td>Portieren von Direct3D 11 zu Direct3D 12</td>
        <td>[Portieren von Direct3D 11 zu Direct3D 12](https://msdn.microsoft.com/library/windows/desktop/mt431709.aspx)</td>
    </tr>
    <tr>
        <td>Konzepte für die Ressourcenbindung (deckt Deskriptor, Deskriptortabelle, Deskriptorheap und Stammsignatur ab) </td>
        <td>[Ressourcenbindung in Direct3D 12](https://msdn.microsoft.com/library/windows/desktop/dn899206.aspx)</td>
    </tr>
    <tr>
        <td>Verwalten des Arbeitsspeichers</td>
        <td>[Arbeitsspeicherverwaltung in Direct3D 12](https://msdn.microsoft.com/library/windows/desktop/dn899198.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Unterstützung für DirectX 12](https://github.com/Microsoft/DirectXTK/issues/2)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[DirectX 12 auf Nvidia-GPUs](https://developer.nvidia.com/dx12-dos-and-donts-updated)</td>
    </tr>
    <tr>
        <td>Intel: Effizientes Rendering mit DirectX 12</td>
        <td>[DirectX 12-Rendering auf Intel-Grafikkarten](https://software.intel.com/sites/default/files/managed/4a/38/Efficient-Rendering-with-DirectX-12-on-Intel-Graphics.pdf)</td>
    </tr>
    <tr>
        <td>Intel: Mehrfachadapterunterstützung in DirectX 12</td>
        <td>[Implementieren einer expliziten Mehrfachadapteranwendung mit DirectX 12](https://software.intel.com/articles/multi-adapter-support-in-directx-12)</td>
    </tr>
    <tr>
        <td>Intel: DirectX 12-Lernprogramm</td>
        <td>[Gemeinsames Whitepaper von Intel, Suzhou Snail und Microsoft](https://software.intel.com/articles/tutorial-migrating-your-apps-to-directx-12-part-1)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Kacheln, Badges und Benachrichtigungen](https://msdn.microsoft.com/library/windows/apps/mt185606)</td>
    </tr>
    <tr>
        <td>Beispiel zur Veranschaulichung von Live-Kacheln und Benachrichtigungen</td>
        <td>[Benachrichtigungsbeispiel](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/Notifications)</td>
    </tr>
    <tr>
        <td>Vorlagen für adaptive Kacheln (Blogbeitrag)</td>
        <td>[Vorlagen für adaptive Kacheln – Schema und Dokumentation](http://blogs.msdn.com/b/tiles_and_toasts/archive/2015/06/30/adaptive-tile-templates-schema-and-documentation.aspx)</td>
    </tr>
    <tr>
        <td>Gestalten von Kacheln und Signalen</td>
        <td>[Richtlinien für Kacheln und Signale](https://msdn.microsoft.com/library/windows/apps/hh465403)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Tool zum Erstellen aller erforderlichen Kacheln über ein einziges Image](https://visualstudiogallery.msdn.microsoft.com/09611e90-f3e8-44b7-9c83-18dba8275bb2)</td>
    </tr>
    <tr>
        <td>UWP-Erweiterung für die Generierung von Kacheln für Visual Studio (Blogbeitrag)</td>
        <td>[Tipps zum Verwenden des UWP-Tools für die Generierung von Kacheln](https://blogs.windows.com/buildingapps/2016/02/15/uwp-tile-generator-extension-for-visual-studio/)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Unterstützen von Käufen von In-App-Produkten](https://msdn.microsoft.com/library/windows/apps/mt219684)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[IAP-Übermittlungen](https://msdn.microsoft.com/library/windows/apps/mt148551)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>[Analyse des kritischen Pfads in WPA](https://channel9.msdn.com/Shows/Defrag-Tools/Defrag-Tools-156-Critical-Path-Analysis-with-Windows-Performance-Analyzer)</td>
    </tr>
    <tr>
        <td>Diagnostizieren von Speicherverwendung und Arbeitsspeicherverlusten mit Windows Performance Recorder (Video)</td>
        <td>[Speicherbedarf und Arbeitsspeicherverluste](https://channel9.msdn.com/Shows/Defrag-Tools/Defrag-Tools-154-Memory-Footprint-and-Leaks)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Konfigurieren von ProcDump zum Erstellen von Speicherabbilddateien](https://channel9.msdn.com/Shows/Defrag-Tools/Defrag-Tools-131-Windows-10-SDK)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Erweiterte DirectX 12-Grafiken und -Leistung](http://channel9.msdn.com/Events/GDC/GDC-2015/Advanced-DirectX12-Graphics-and-Performance)</td>
    </tr>
    <tr>
        <td>Debuggen von DirectX-Grafiken (Video)</td>
        <td>[Lösen Sie komplexe Grafikprobleme in Ihrem Spiel mithilfe von DirectX-Tools.](http://channel9.msdn.com/Events/GDC/GDC-2015/Solve-the-Tough-Graphics-Problems-with-your-Game-Using-DirectX-Tools)</td>
    </tr>
    <tr>
        <td>Visual Studio 2015-Tools zum Debuggen von DirectX 12 (Video)</td>
        <td>[DirectX-Tools für Windows 10 in Visual Studio 2015](https://channel9.msdn.com/Series/ConnectOn-Demand/212)</td>
    </tr>
    <tr>
        <td>Direct3D 12-Programmieranleitung</td>
        <td>[Direct3D 12-Programmieranleitung](https://msdn.microsoft.com/library/windows/desktop/dn903821)</td>
    </tr>
    <tr>
        <td>Kombinieren von DirectX und XAML</td>
        <td>[Interoperabilität von DirectX und XAML](directx-and-xaml-interop.md)</td>
...
<table>
    ...
    <tr>
        ...
        <td>[Richtlinien für die Entwicklung für eine weltweite Zielgruppe](https://msdn.microsoft.com/library/windows/apps/xaml/mt186453.aspx)</td>
    </tr>
    <tr>
        <td>Überwinden sprachlicher, kultureller und technologischer Barrieren</td>
        <td>[Onlineressource für Sprachkonventionen und Microsoft-Standardterminologie](http://www.microsoft.com/Language/Default.aspx)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>App-Veröffentlichung über das Windows Dev Center</td>
        <td>[Veröffentlichen von Windows-Apps](https://dev.windows.com/publish)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Ein Workflow für das Zuweisen von Altersfreigaben über das IARC-System](https://blogs.windows.com/buildingapps/2016/01/06/now-available-single-age-rating-system-to-simplify-app-submissions/)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Erstellen von hochladbaren Paketen ohne Zugriff auf das Store-Konto des Veröffentlichers](https://blogs.windows.com/buildingapps/2015/12/15/building-an-app-for-a-3rd-party-how-to-package-their-store-app/)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>Vereinbarung für Entwickler von Windows Store-Apps</td>
        <td>[Vereinbarung für App-Entwickler](https://msdn.microsoft.com/library/windows/apps/hh694058)</td>
    </tr>
    <tr>
        <td>Richtlinien für die Veröffentlichung von Apps im Windows Store</td>
        <td>[Windows Store-Richtlinien](https://msdn.microsoft.com/library/windows/apps/dn764944)</td>
    </tr>
    <tr>
        <td>So wird's gemacht: Vermeiden allgemeiner Probleme bei der App-Zertifizierung</td>
        <td>[Vermeiden allgemeiner Zertifizierungsfehler](https://msdn.microsoft.com/library/windows/apps/jj657968)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Dev Center-App unter Windows 10 zum Anzeigen Ihrer veröffentlichten Apps](https://www.microsoft.com/store/apps/dev-center/9nblggh4r5ws)</td>
    </tr>  
    <tr>
        <td>Windows Dev Center-Analysen</td>
        <td>[Analysen](https://msdn.microsoft.com/library/windows/apps/mt148522)</td>
    </tr>
    <tr>
        <td>Reagieren auf Kundenrezensionen</td>
        <td>[Reagieren auf Kundenrezensionen](https://msdn.microsoft.com/library/windows/apps/mt148546)</td>
    </tr>
    <tr>
        <td>Werbemöglichkeiten für Ihr Spiel</td>
        <td>[Bewerben Ihrer Apps](https://dev.windows.com/store-promotion)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Paketversionsnummern](https://msdn.microsoft.com/library/windows/apps/mt188602)</td>
    </tr>
    <tr>
        <td>Leitfaden für die Spielpaketverwaltung</td>
        <td>[Leitfaden für die App-Paketverwaltung](https://msdn.microsoft.com/library/windows/apps/mt188602)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>[Entwickeln mit Xbox Live für Windows 10](http://channel9.msdn.com/Events/GDC/GDC-2015/Developing-with-Xbox-Live-for-Windows-10)</td>
    </tr>
    <tr>
        <td>Plattformübergreifende Spielersuche (Video)</td>
        <td>[Xbox Live Multiplayer: Einführung in die Dienste für plattformübergreifende Spielersuche und Spiele](http://channel9.msdn.com/Events/GDC/GDC-2015/Xbox-Live-Multiplayer-Introducing-services-for-cross-platform-matchmaking-and-gameplay)</td>
    </tr>
    <tr>
        <td>Geräteübergreifendes Spielen in Fable Legends (Video)</td>
        <td>[Fable Legends: Geräteübergreifendes Spielen mit Xbox Live](http://channel9.msdn.com/Events/GDC/GDC-2015/Fable-Legends-Cross-device-Gameplay-with-Xbox-Live)</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>[Kontinuierlich hohe Spieleleistung auf mobilen Multi-Core-Geräten](http://channel9.msdn.com/Events/GDC/GDC-2015/Sustained-gaming-performance-in-multi-core-mobile-devices)</td>
    </tr>
    <tr>
        <td>Entwickeln von Windows 10-Desktopspielen (Video)</td>
        <td>[PC-Spiele für Windows 10](http://channel9.msdn.com/Events/GDC/GDC-2015/PC-Games-for-Windows-10)</td>
    </tr>
</table>
