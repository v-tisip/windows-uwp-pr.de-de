...
Um eine App über Querladen zu verteilen, müssen Sie ein App-Paket (.appx) oder ein App-Bündel (.appxbundle) erstellen und es an einem freigegebenen Speicherort veröffentlichen.
