...
## Die Wahl des richtigen Build-Agents
...
#### Erstellen eines benutzerdefinierten Build-Agents (optional)
...
#### Konfigurieren der Buildaufgabe „NuGet-Wiederherstellen“
...
#### Konfigurieren der Buildaufgabe „Artefakt veröffentlichen“ 
...
## Einrichten eines Continuous Integration (CI)-Builds 
...
### Konfigurieren einer CI-Builddefinition
...
#### Konfigurieren eines benutzerdefinierten Build-Agents für Komponententests
...
### Konfigurieren der Builddefinition für die Ausführung von UWP-Komponententests
...
#### Verbessern der Geschwindigkeit eines CI-Builds
...
#### So verbessern Sie die Geschwindigkeit eines CI-Builds
...
#### Beheben von Fehlern, die beim Bündeln von mehr als einer App in derselben Projektmappe auftreten 
...
## Einrichten eines Continuous Deployment-Builds zum Querladen
...
### Anwenden von Versionsnummern auf Builds
...
#### Optional: Integration in HockeyApp
...
## Einrichten eines Continuous Deployment-Builds, durch den ein Paket an den Store übermittelt wird 
...
#### Konfigurieren der automatischen Übermittlung an den Store
...
### Bewährte Methoden für das Querladen von Apps
...
#### Querladen einer App mit dem Windows10 Anniversary Update
...
### Bewährte Methoden für das Signieren von Zertifikaten 
...
#### Akzeptieren der Vertrauenswürdigkeit des Signaturzertifikats auf den Zielgeräten
