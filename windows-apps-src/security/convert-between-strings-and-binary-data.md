...
ms.locfileid: "4021340"
---
# <a name="convert-between-strings-and-binary-data"></a><span data-ttu-id="17b06-104">Umwandlung zwischen Zeichenfolgen und binären Daten</span><span class="sxs-lookup"><span data-stu-id="17b06-104">Convert between strings and binary data</span></span>



<span data-ttu-id="17b06-105">Dieser Beispielcode zeigt, wie Sie zwischen Zeichenfolgen und binären Daten in einer UWP-App (Universelle Windows-Plattform) konvertieren können.</span><span class="sxs-lookup"><span data-stu-id="17b06-105">This example code shows how to convert between strings and binary data in an Universal Windows Platform (UWP) app.</span></span>
