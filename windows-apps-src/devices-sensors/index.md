...
| [Point of Service](point-of-service.md) | In diesem Abschnitt wird beschrieben, wie zur Interaktion mit Punkt Service Peripheriegeräte, wie Barcode-Scanner, Bestätigung Drucker, gezahlten Fächer. | 
