...
## <a name="sharing-a-device-between-apps"></a><span data-ttu-id="b0bb1-161">Teilen eines Geräts zwischen Apps</span><span class="sxs-lookup"><span data-stu-id="b0bb1-161">Sharing a device between apps</span></span>
