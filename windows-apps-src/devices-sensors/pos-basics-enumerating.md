...
Die einfachste Möglichkeit zum Abrufen eines POS-Geräts ist mit **GetDefaultAsync** des ersten verfügbaren Geräts innerhalb einer Geräteklasse Point of Service. 
...
> - Änderung bei Network attached Point of Service-Geräten in Ihrem Netzwerk verfügbar
...
In diesem Beispiel wird die Auswahl einer Momentaufnahme von Geräten mit **FindAllAsync** den oben definierten verwendet und durchläuft alle von der Sammlung zurückgegebenen Elemente und schreibt Device Name und ID in die Debugausgabe geschrieben. 
