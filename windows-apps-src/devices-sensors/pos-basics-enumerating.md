...
<br/>
Zeigen Sie eine Geräteauswahl-UI an und den Benutzer ein verbundenen Gerät auswählen. Diese Methode behandelt die Liste aktualisieren, wenn Geräte angeschlossen und entfernt werden, und ist einfacher und sicherer als andere Methoden.
...
> - Änderung bei den Network attached Point of Service-Geräte in Ihrem Netzwerk verfügbar
...
In diesem Beispiel wird die Auswahl einer Momentaufnahme von Geräten mit **FindAllAsync** den oben definierten verwendet und dann durchläuft alle von der Sammlung zurückgegebenen Elemente und schreibt Device Name und ID in die Debugausgabe geschrieben. 
