...
Das folgende Beispiel zeigt, wie zum Initiieren der Überprüfung mithilfe eines Software-Triggers, der angehalten wird, nachdem sie einen Strichcode scannt Überprüfung:
