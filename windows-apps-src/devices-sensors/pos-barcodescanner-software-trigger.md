...
Das folgende Beispiel zeigt, wie zum Initiieren der Überprüfung mithilfe eines Software-Triggers, das Scannen, nachdem sie einen Strichcode scannt beendet wird:
