...
* **Bereich**: Längen zwischen **DecodeLength1** und **DecodeLength2** Single-Byte-Zeichen zu decodieren. Die Reihenfolge der **DecodeLength1** und **DecodeLength2** führen Sie keine Rolle (entweder höheren oder niedrigeren als die andere möglich).
