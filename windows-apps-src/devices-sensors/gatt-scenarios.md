...
translationtype: HT
---
# <a name="bluetooth-gatt"></a>BluetoothGATT
...
## <a name="control-a-bluetooth-le-thermometer-device"></a>Steuern eines BluetoothLE-Thermometers
...
## <a name="control-the-presentation-of-bluetooth-le-device-data"></a>Steuern der Darstellung von BluetoothLE-Gerätedaten
