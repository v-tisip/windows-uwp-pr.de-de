...
Beim Portieren in den entsprechenden C++ / WinRT-Code die hütchen entfernt und ändern Sie den Pfeiloperator (-&gt;) in den Punktoperator (.), da C++ / WinRT-projizierte Typen sind Werte und keine Zeiger sind.
