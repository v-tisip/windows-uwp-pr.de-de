...
-   Die [**Speicherorte**](https://msdn.microsoft.com/library/windows/apps/dn627552) -Eigenschaft der [**MapLocationFinderResult**](https://msdn.microsoft.com/library/windows/apps/dn627551) stellt eine Sammlung von [**MapLocation**](https://msdn.microsoft.com/library/windows/apps/dn627549) Objekte bereit. 
...
1.  Rufen Sie eine der Überladungen der [**FindLocationsAsync**](https://msdn.microsoft.com/library/windows/apps/dn636925) -Methode der [**MapLocationFinder**](https://msdn.microsoft.com/library/windows/apps/dn627550) -Klasse mit einem Ortsnamen oder die Adresse.
...
In diesem Abschnitt zeigt, wie Sie konvertieren einen geografischen Standort in eine Adresse (umgekehrte geocodierung).
...
3.  Verwenden Sie die [**Speicherorte**](https://msdn.microsoft.com/library/windows/apps/dn627552) -Eigenschaft der [**MapLocationFinderResult**](https://msdn.microsoft.com/library/windows/apps/dn627551) , um eine Sammlung [**MapLocation**](https://msdn.microsoft.com/library/windows/apps/dn627549) -Objekte verfügbar zu machen. Da das System mehreren Standorten finden kann, die der Eingabe entsprechen, möglicherweise mehrere [**MapLocation**](https://msdn.microsoft.com/library/windows/apps/dn627549) Objekte sein.
4.  [**MapAddress**](https://msdn.microsoft.com/library/windows/apps/dn627533) Objekten über die Eigenschaft [**Adresse**](https://msdn.microsoft.com/library/windows/apps/dn636929) der einzelnen [**MapLocation**](https://msdn.microsoft.com/library/windows/apps/dn627549).
...
* [Video: Nutzen von Karten und Position per Handy, Tablet oder PC in Ihren Windows-Apps](https://channel9.msdn.com/Events/Build/2015/2-757)
