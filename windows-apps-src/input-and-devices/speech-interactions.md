...
> [!NOTE]
> Mit **Cortana** und angepassten Sprachbefehlen kann Ihre App im Vordergrund gestartet (die App erhält wie beim Starten über das Startmenü den Fokus) oder als Hintergrunddienst aktiviert werden (**Cortana** behält den Fokus, es werden aber Ergebnisse aus der App angezeigt).
> 
