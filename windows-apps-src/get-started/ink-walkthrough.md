...
---
# <a name="support-ink-in-your-uwp-app"></a>Unterstützen von Freihandeingaben in Ihrer UWP-App
...
Weitere Informationen zur Implementierung dieser Features finden Sie unter [Zeichenstift-Interaktionen und Windows Ink in UWP-Apps](https://docs.microsoft.com/windows/uwp/input-and-devices/pen-and-stylus-interactions).
...
* Wenn Sie noch keine Erfahrung mit der App-Entwicklung in der Universellen Windows-Plattform (UWP) mit Visual Studio haben, werfen Sie einen Blick in diese Themen, bevor Sie dieses Lernprogramm starten:  
    * [Vorbereiten](https://docs.microsoft.com/en-us/windows/uwp/get-started/get-set-up)
    * [Erstellen der App „Hello, world“ (XAML)](https://docs.microsoft.com/en-us/windows/uwp/get-started/create-a-hello-world-app-xaml-universal)
...
<tr>
 <td width=125><img src="images/challenge-icon.png"></td>
    <td width=500>Hier ist ein Beispiel für eine benutzerdefinierte <strong><a href="https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.inktoolbar">InkToolbar</a></strong> (von Skizzenblock im Windows Ink-Arbeitsbereich).
...
<tr>
 <td width=125><img src="images/challenge-icon.png"></td>
    <td width=500><p>Windows Ink unterstützt Texterkennung für viele der von Windows unterstützten Sprachen. Jedes Sprachpaket enthält ein Schrifterkennungsmodul, das mit dem Language Pack installiert werden kann.</p>
    <p>Zielen Sie auf eine bestimmte Sprache ab, indem Sie die installierten Handschrifterkennungsmodule abfragen.</p>
    <p>Weitere Informationen zur internationalen Handschrifterkennung finden Sie unter <a href="https://docs.microsoft.com/windows/uwp/input-and-devices/convert-ink-to-text">Windows Ink-Striche als Text erkennen</a>.</p>
</tr>
</table>
...
<tr>
 <td width=125><img src="images/challenge-icon.png"></td>
    <td width=500><p>Für dieses Lernprogramm muss eine Schaltfläche zum Initiieren der Erkennung gedrückt werden. Sie können auch dynamische Erkennung mithilfe einer einfachen Timing-Funktion ausführen.</p>

Weitere Informationen zur dynamischen Handschrifterkennung finden Sie unter [Windows Ink-Striche als Text erkennen](https://docs.microsoft.com/en-us/windows/uwp/input-and-devices/convert-ink-to-text).
</tr>
</table>
...
<tr>
 <td width=125><img src="images/challenge-icon.png"></td>
    <td width=500><p>Windows-Freihandeingabe unterstützt auch das Kopieren und Einfügen von Freihandstrichen zur und aus der Zwischenablage.

Weitere Informationen zur Verwendung der Zwischenablage mit Freihandeingabe finden Sie unter [Speichern und Abrufen von Windows Ink](https://docs.microsoft.com/en-us/windows/uwp/input-and-devices/save-and-load-ink).
</tr>
</table>
...
* [Stiftinteraktionen und Windows Ink in UWP-Apps](https://docs.microsoft.com/windows/uwp/input-and-devices/pen-and-stylus-interactions)
