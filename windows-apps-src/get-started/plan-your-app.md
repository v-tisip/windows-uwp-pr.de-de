...
**App-Verträge**Ihre app kann im app-Verträge, die umfassende, App- und funktionsübergreifende benutzerflüsse ermöglichen teilnehmen.

-   **Teilen**ermöglichen Sie Benutzern Teilen von app-Inhalten mit über andere apps und empfangen freigabefähiger Inhalte von anderen Benutzern und apps zu.
...
**Toucheingabe**Windows bietet eine einzigartige und charakteristische Toucheingabe, die mehr als nur die Funktionen einer Maus emulieren.
...
-   **Animationen**Animationen aus unserer Bibliothek verwenden, um schnellen und flüssigen app für Ihre Benutzer zu entwickeln. Helfen Sie Benutzern, Kontextänderungen zu verstehen, und verbinden Sie Interaktionen mit visuellen Übergängen. Weitere Informationen zum [Animieren der UI](../graphics/animations-overview.md).
-   **Popupbenachrichtigungen**ermöglichen Sie Benutzern Termine oder persönlich relevante mithilfe von Popupbenachrichtigungen Inhalte, und bitten Sie sie wieder zu Ihrer app auch, wenn die app geschlossen ist. Weitere Informationen zu [Kacheln, Infoanzeigen und Popupbenachrichtigungen](../design/shell/tiles-and-notifications/index.md).
...
-   **Benutzerkacheln**  gestalten Sie Ihre app noch persönlicher für Benutzer von laden ihrer oder Benutzern Inhalte aus Ihrer app als persönliche Kachel in Windows festzulegen.

**Gerätefunktionen**achten, dass Ihre app nutzt die Funktionen moderner Geräte.

-   **Näherungsgesten**ermöglichen Sie Benutzern Geräte mit anderen Benutzern zu verbinden, die physisch in der Nähe, indem Sie die Geräte physisch simuliert (Multiplayer-Spiele). Weitere Informationen hierzu finden Sie unter [Näherung und Kopplung](https://msdn.microsoft.com/library/windows/apps/hh465229).
-   **Kameras und externe Speichergeräte**die integrierte oder angeschlossen Kameras für chatten und Konferenzen, Aufzeichnung Vlogs, Profil Pics, um der Welt um, wobei die Benutzer herstellen oder den Aktivität Ihre app ist ideal geeignet. Weitere Informationen zum [Zugreifen auf Inhalte auf Wechselspeichermedien](https://msdn.microsoft.com/library/windows/apps/hh465189).
...
-   **GeoLocation**verwenden Sie Standortinformationen in standardwebdaten oder von standortsensoren, damit Benutzer umgehen, ihre Position auf einer Karte ermitteln oder Hinweise in der Nähe Personen, Aktivitäten und Zielorte zu erhalten. Weitere Informationen zum [geografischen Standort](https://msdn.microsoft.com/library/windows/apps/hh465139).
