...
-   **Animationen**verwenden Sie Animationen aus unserer Bibliothek, um Ihre app schnellen und flüssigen für Ihre Benutzer zu stellen. Helfen Sie Benutzern, Kontextänderungen zu verstehen, und verbinden Sie Interaktionen mit visuellen Übergängen. Weitere Informationen zum [Animieren der UI](../graphics/animations-overview.md).
...
-   **Benutzerkacheln**  gestalten Sie Ihre app noch persönlicher für Benutzer von laden ihrer oder lassen die Benutzer Inhalte aus Ihrer app als persönliche Kachel in Windows festzulegen.
...
-   **Kameras und externe Speichergeräte**ihre integrierte oder angeschlossen Kameras für chatten und Konferenzen, Aufzeichnung Vlogs, wobei Profil Pics, Dokumentieren der Welt um sie Ihren Benutzern herstellen oder Aktivitäten einhergeht Ihrer app eignet sich sehr gut. Weitere Informationen zum [Zugreifen auf Inhalte auf Wechselspeichermedien](https://msdn.microsoft.com/library/windows/apps/hh465189).
...
**Wie sollten Befehle organisiert?** Anhand der Übersicht über die Schritte im Fluss um potenzielle Befehle zu identifizieren, die Sie zum Entwerfen von müssen. Überlegen Sie dann, wo sich diese Befehle in der App befinden sollen.

-   **Versuchen Sie immer, den Inhalt zu verwenden.** Wann immer möglich, bieten Sie Benutzern den Inhalt auf der app-Canvas direkt bearbeiten, anstatt diese Handlung auf den Inhalt Befehle hinzufügen. Lassen Sie beispielsweise in der Reise-App zu, dass Benutzer ihre Reiseroute durch Ziehen und Ablegen von Aktivitäten in einer Liste auf der Canvas neu gestalten, anstatt die Aktivität auswählen und sie mithilfe der Befehlsschaltflächen zum Verschieben nach oben bzw. nach unten neu anordnen zu müssen.
