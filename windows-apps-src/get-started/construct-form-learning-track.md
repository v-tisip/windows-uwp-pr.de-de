...
Auch wenn Sie hier ein Formular erstellt haben, gelten die Konzepte von Layouts und Steuerelementen für alle XAML-Benutzeroberflächen, die Sie möglicherweise erstellen. Durch die Dokumente zurück, wir haben Sie verknüpft und mit dem Formular haben Sie neue UI Features und die Benutzerfunktionalität eingrenzen, das experimentieren, können. Schrittweise Anleitung durch detailliertere Layoutfeatures, finden Sie unter unseren [adaptive Layout-Lernprogramm](../design/basics/xaml-basics-adaptive-layout.md)
