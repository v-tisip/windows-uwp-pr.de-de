...
<ul>
<li>[**QuickInfo-Klasse**](https://msdn.microsoft.com/library/windows/apps/br227608)</li>
<li>[**ToolTipService-Klasse**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.tooltipservice)</li>
</ul>
</div>
