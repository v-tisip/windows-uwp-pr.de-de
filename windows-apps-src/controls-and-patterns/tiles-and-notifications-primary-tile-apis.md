...
<ul>
<li>[**StartScreenManager-Klasse**](https://docs.microsoft.com/en-us/uwp/api/windows.ui.startscreen.startscreenmanager)</li>
...
* [Dokumentation zu adaptiven Kacheln](tiles-and-notifications-create-adaptive-tiles.md)