...
ms.prod: windows
ms.technology: uwp
keywords: "Windows 10, UWP, Windows Store-Übermittlungs-API, Übernehmen einer Add-On-Übermittlung, In-App-Produkt, IAP"
...
# <a name="commit-an-add-on-submission-using-the-windows-store-submission-api"></a>Übernehmen einer Add-On-Übermittlung mit der Windows Store-Übermittlungs-API
