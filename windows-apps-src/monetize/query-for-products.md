...
| productTypes      | Liste&lt;Zeichenfolge&gt;       | Gibt an, welche Produkte, die in die Ergebnisse der Abfrage zurückgegeben. Unterstützte Produkttypen sind **Application**, **Durable** und **UnmanagedConsumable**.     | Ja       |
