...
| 0x803f6107 fest   | Ein unerwartetes passiert während der Verarbeitung des aktuellen Vorgangs.                                             |
| 0x803F6108   | Die in-app-Kauf konnte nicht abgeschlossen werden, da die app-Lizenz Informationen nicht vorhanden ist. Dieser Fehler kann auftreten, wenn Sie Ihre app-querzuladen. Um dieses Problem zu beheben, deinstallieren Sie die app, und installieren sie aus dem Speicher die app-Lizenz zu aktualisieren.                                          |
...
| 0x803F610A   | Der Typ der angegebenen Anbieter für das Benutzerkonto für den Store wird nicht unterstützt.                                            |
...
| 0 x 80040003   | Das Ziel der Erfüllung ist ungültig.                       |
...
| 0x803F8001   | Sie müssen nicht über eine Berechtigung für das Produkt. Sie können ein anderes Microsoft-Konto als der verwenden, die verwendet wurde, um das Produkt zu erwerben.           |
...
## <a name="self-install-update-error-codes"></a>Update-Fehlercodes selbst installieren
...
| 0x803F6201   | Zustimmung des Benutzers wird zum Herunterladen und installieren das paketupdate erforderlich.                                                  |
| 0x803F6203   | Zustimmung des Benutzers ist erforderlich, um das paketupdate zu installieren.                                         |
| 0x803F6204   | Zustimmung des Benutzers ist erforderlich, um das paketupdate heruntergeladen werden, da der Download ein getaktetes Netzwerkverbindung ausgeführt wird.                                             |
| 0x803F6206   | Zustimmung des Benutzers ist erforderlich, herunterladen und installieren das paketupdate, da der Download ein getaktetes Netzwerkverbindung ausgeführt wird.     |
