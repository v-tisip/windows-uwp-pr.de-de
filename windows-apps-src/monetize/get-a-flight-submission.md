...
Verwenden Sie diese Methode in der Windows Store-Übermittlungs-API, um Daten für eine vorhandene Flight-Paketübermittlung abzurufen. Weitere Informationen zum Erstellungsprozess einer Flight-Paketübermittlung mithilfe der Windows Store-Übermittlungs-API finden Sie unter [Verwalten von Flight-Paketübermittlungen](manage-flight-submissions.md).
