...
# <a name="manage-package-flight-submissions-using-the-windows-store-submission-api"></a>Verwalten von Flight-Paket-Übermittlungen mit der Windows Store-Übermittlungs-API
...
<td align="left">[Abrufen einer vorhandenen Flight-Paket-Übermittlung](get-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">GET</td>
...
<td align="left">[Abrufen des Status einer vorhandenen Flight-Paket-Übermittlung](get-status-for-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions```</td>
<td align="left">[Erstellen einer neuen Flight-Paket-Übermittlung](create-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">PUT</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}```</td>
<td align="left">[Aktualisieren einer vorhandenen Flight-Paket-Übermittlung](update-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/commit```</td>
<td align="left">[Committen einer neuen oder aktualisierten Flight-Paket-Übermittlung](commit-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">DELETE</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}```</td>
<td align="left">[Löschen einer Flight-Paket-Übermittlung](delete-a-flight-submission.md)</td>
</tr>
</tbody>
</table>
...
3. [Erstellen Sie eine Flight-Paket-Übermittlung](create-a-flight-submission.md) mithilfe der folgenden Methode in der Windows Store-Übermittlungs-API. Diese Methode erstellt eine neue laufende Übermittlung, die eine Kopie der letzten veröffentlichten Übermittlung ist.
  ...
  Der Antworttext enthält drei Elemente: die ID der neuen Übermittlung, die Daten für die neue Übermittlung (einschließlich aller Einträge und Preisinformationen) und den Shared Access Signature (SAS)-URI, um alle Pakete für die Übermittlung auf Azure Blob Storage hochzuladen.
...
5. Führen Sie folgende Methode aus, um [die Flight-Paket-Übermittlung zu committen](commit-a-flight-submission.md). Hierdurch wird Dev Center darüber benachrichtigt, dass Sie Ihre Übermittlung fertig gestellt haben und die Updates nun auf Ihr Konto jetzt angewendet werden sollen.
...
Um ein graduelles Paketrollout für eine Flight-Paket-Übermittlung programmgesteuert zu aktivieren, gehen Sie wie folgt vor, und verwenden Sie dabei Methoden in der Windows Store-Übermittlungs-API:
...
<td align="left">[Abrufen der Informationen zu einem graduellen Rollout für eine Flight-Paket-Übermittlung](get-package-rollout-info-for-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/updatepackagerolloutpercentage```</td>
<td align="left">[Aktualisieren des Prozentsatzes eines graduellen Rollouts für eine Flight-Paket-Übermittlung](update-the-package-rollout-percentage-for-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/haltpackagerollout```</td>
<td align="left">[Anhalten des graduellen Rollouts für eine Flight-Paket-Übermittlung](halt-the-package-rollout-for-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/finalizepackagerollout```</td>
<td align="left">[Abschließen des graduellen Rollouts für eine Flight-Paket-Übermittlung](finalize-the-package-rollout-for-a-flight-submission.md)</td>
</tr>
</tbody>
</table>
...
Die Methoden der Windows Store-Übermittlungs-API für das Verwalten von Flight-Paket-Übermittlungen verwenden die folgenden JSON-Datenressourcen.
...
>**Hinweis**&nbsp;&nbsp;Beim Aufruf der Methode für das [Aktualisieren einer Flight-Paket-Übermittlung](update-a-flight-submission.md) sind im Anforderungstext nur die Werte *fileName*, *fileStatus*, *minimumDirectXVersion* und *minimumSystemRam* dieses Objekts erforderlich. Die übrigen Werte werden von Dev Center aufgefüllt.
