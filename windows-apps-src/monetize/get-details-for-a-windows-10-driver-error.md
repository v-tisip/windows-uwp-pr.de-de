...
description: "Verwenden Sie diese Methode in der Windows Store-Analyse-API, um detaillierte Daten zu einem Windows10-Treiberfehler zu erhalten. Diese Methode ist nur für IHVs bestimmt."
