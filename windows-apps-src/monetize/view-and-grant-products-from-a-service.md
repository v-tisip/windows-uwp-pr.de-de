...
3.  Sie werden auf der Anwendung main Registrierungsseite weitergeleitet. Kopieren Sie auf dieser Seite die **Anwendungs-ID** -Wert zur späteren Verwendung.
