...
* Erstellen Sie eine Flight-Paket für eine app. Sie können dies im Partner Center oder hierzu können Sie mithilfe der Methode zum [Erstellen eines Flight-Pakets](create-a-flight.md) .
