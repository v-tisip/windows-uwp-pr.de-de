...
Die folgenden Beispiele zeigen verschiedene Anforderungen für das Abrufen von Add-On-Kaufdaten. Ersetzen Sie die *AddonProductId* und *ApplicationId* Werte durch die entsprechende Store-ID für die app oder Ihr Add-on.
