...
| addonProductName    | string  | Der Anzeigename des Add-Ons. Dieser Wert wird nur in den Antwortdaten der *AggregationLevel* -Parameter auf **Tag**, festgelegt ist, wenn Sie das Feld **AddonProductName** im *Groupby* Parameter angeben.                                                                                                                                                                                                            |
