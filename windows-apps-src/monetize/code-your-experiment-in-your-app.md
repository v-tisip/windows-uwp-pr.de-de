...
* Werte von remotevariablen in Partner Center zu erhalten.
* Remotevariablen zum Konfigurieren von App-Funktionen für die Benutzer zu verwenden
* Protokollieren von Ereignissen in das Partner Center, die angeben, wann Benutzer Ihr Experiment angezeigt haben, und eine gewünschte Aktion (auch als eine *Konvertierung*) ausgeführt.
