---
author: mcleanbyron
description: "Verwenden Sie diese Methode in der Windows Store-Übermittlungs-API, um das Paketrollout für ein Flight-Paket anzuhalten."
title: "Anhalten des Paketrollouts für ein Flight-Paket mit der Windows Store-Übermittlungs-API"
...
# Anhalten des Paketrollouts für ein Flight-Paket mit der Windows Store-Übermittlungs-API
...
* Ermöglichen Sie ein schrittweises Paketrollout für die Übermittlung. Sie können dies im [Dev Center-Dashboard](../publish/gradual-package-rollout.md) oder durch [Verwenden der Windows Store-Übermittlungs-API](manage-flight-submissions.md#manage-gradual-package-rollout) durchführen.
...
| 409  | Dieser Code weist auf einen der folgenden Fehler hin:<br/><br/><ul><li>Die Übermittlung befindet sich nicht in einem gültigen Status für das schrittweise Rollout (vor dem Aufrufen dieser Methode muss die Übermittlung veröffentlicht und der Wert für [packageRolloutStatus](manage-flight-submissions.md#package-rollout-object) auf **PackageRolloutInProgress** festgelegt werden).</li><li>Die Übermittlung gehört nicht zur angegebenen App.</li><li>Die App verwendet eine Dev Center-Dashboard-Funktion, die [derzeit nicht von der Windows Store-Übermittlungs-API unterstützt wird](create-and-manage-submissions-using-windows-store-services.md#not_supported).</li></ul> |   
