...
Verwenden Sie diese Methode der Windows Store-Übermittlungs-API, um den Status einer Flight-Paket-Übermittlung abzurufen. Weitere Informationen über den Erstellungsprozess einer Flight-Paketübermittlung mithilfe der Windows Store-Übermittlungs-API finden Sie unter [Verwalten von Flight-Paketübermittlungen](manage-flight-submissions.md).
