...
#### [Verwenden von OpenCV mit „MediaFrameReader”](../audio-video-camera/process-audio-frames-with-mediaframereader.md)
...
##### [Codieren der App für Tests](../monetize/code-your-experiment-in-your-app.md)
##### [Definieren des Experiments im Dashboard](../monetize/define-your-experiment-in-the-dev-center-dashboard.md)
##### [Verwalten des Experiments im Dashboard](../monetize/manage-your-experiment.md)
...
###### [Abrufen von Xbox One-Spielekäufen](../monetize/get-xbox-one-game-acquisitions.md)
###### [Abrufen von Xbox Live-Analysedaten](../monetize/get-xbox-live-analytics.md)
...
### [Einführung in C++/WinRT](../cpp-and-winrt-apis/intro-to-using-cpp-with-winrt.md)
### [Erste Schritte mit C++/WinRT](../cpp-and-winrt-apis/get-started.md)
### [Häufig gestellte Fragen](../cpp-and-winrt-apis/faq.md)
### [Problembehandlung](../cpp-and-winrt-apis/troubleshooting.md)
### [C++/WinRT-Beispielanwendung eines Foto-Editors](../cpp-and-winrt-apis/photo-editor-sample.md)
### [String-Verarbeitung](../cpp-and-winrt-apis/strings.md)
### [C++-Standarddatentypen und C++/WinRT](../cpp-and-winrt-apis/std-cpp-data-types.md)
### [Boxing und Unboxing von Einzelwerten für IInspectable](../cpp-and-winrt-apis/boxing.md)
### [Verwenden von APIs mit C++/WinRT](../cpp-and-winrt-apis/consume-apis.md)
### [Erstellen von APIs mit C++/WinRT](../cpp-and-winrt-apis/author-apis.md)
### [Fehlerbehandlung bei C++/WinRT](../cpp-and-winrt-apis/error-handling.md)
### [Verarbeiten von Ereignissen über Delegaten](../cpp-and-winrt-apis/handle-events.md)
### [Erstellen von Ereignissen](../cpp-and-winrt-apis/author-events.md)
### [Sammlungen mit C++ / WinRT](../cpp-and-winrt-apis/collections.md)
...
### [XAML-Items-Steuerelemente; Binden an eine C++/WinRT-Collection](../cpp-and-winrt-apis/binding-collection.md)
### [Benutzerdefinierte (vorlagenbasierte) XAML-Steuerelemente mit C++ / WinRT](../cpp-and-winrt-apis/xaml-cust-ctrl.md)
### [Verwenden von COM-Komponenten mit C++ / WinRT](../cpp-and-winrt-apis/consume-com.md)
### [Erstellen von COM-Komponenten mit C++ / WinRT](../cpp-and-winrt-apis/author-coclasses.md)
### [Interoperabilität zwischen C++/WinRT und C++/CX](../cpp-and-winrt-apis/interop-winrt-cx.md)
### [Wechsel zu C++/WinRT von C++/CX](../cpp-and-winrt-apis/move-to-winrt-from-cx.md)
### [Interoperabilität zwischen C++/WinRT und der ABI](../cpp-and-winrt-apis/interop-winrt-abi.md)
### [Wechsel zu C++/WinRT von WRL](../cpp-and-winrt-apis/move-to-winrt-from-wrl.md)
### [Schwache Referenzen](../cpp-and-winrt-apis/weak-references.md)
...
### [UWP-Steuerelemente in WPF- oder Windows Forms-Anwendung](../xaml-platform/xaml-host-controls.md)
