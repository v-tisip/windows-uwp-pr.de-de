...
| Wartungsoption | Verfügbarkeit von neuen Featureupgrades zur Installation | Wartungslebensdauer | Wichtigste Vorteile | Unterstützte Editionen |
| --- | --- | --- | --- | --- |
...
Ging Windows7 wurde Kompatibilität sehr viel proaktiv. Wir betrachten diese unterschiedlich Schritte Windows8, arbeiten im Nachhinein für Kompatibilität von Windows wurde von Design und nicht erst im Nachhinein. Windows 10 ist die am häufigsten kompatiblen entwurfsbedingt Betriebssystemversion. Hier einige wichtige Aspekte, die uns bei der Umsetzung geholfen haben:
...
Wir empfehlen allen ISVs von Win32-Apps, zukünftig [UWP (Universelle Windows-Plattform)-Apps](http://go.microsoft.com/fwlink/?LinkID=780560) und insbesondere [Centennial](http://go.microsoft.com/fwlink/?LinkID=780562)-Apps zu entwickeln. Die Entwicklung dieser App-Pakete birgt deutliche Vorteile gegenüber der Verwendung herkömmlicher Win32-Installationsprogramme. UWP-apps sind auch im [Microsoft Store](http://go.microsoft.com/fwlink/?LinkID=780563)unterstützt daher es für Sie einfacher ist, die Ihre Benutzer automatisch, um eine konsistente Version zu aktualisieren Ihre Supportkosten zu senken.
...
Sie haben Zugriff auf Vorabversionen von Windows 10, Windows 10 Mobile, und das aktuelle Windows SDK und der Emulator, müssen Sie alle Tools zur Verfügung, die zum Entwickeln großartiger apps und entdecken Sie Neuigkeiten in der universellen Windows-Plattform und den Microsoft Store.
