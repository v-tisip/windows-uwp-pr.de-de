...
| Summe          | N/V           | N/V                                                              | Summe aller Glanzkomponenten des Lichts                                                          |
| N            | N/V           | 3D-Vektor (X-, Y- und Z-Gleitkommawerte)                    | Vertexnormale                                                                                         |
...
| L<sub>dir</sub> | N/V           | 3D-Vektor (X-, Y- und Z-Gleitkommawerte) | Richtungsvektor von der Vertexposition zur Lichtposition |
