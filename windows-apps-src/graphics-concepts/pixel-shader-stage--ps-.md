...
Wenn die Pipeline ohne einen Geometrieshader konfiguriert wurde, ist ein Pixelshader auf 16 4-Komponenten-Eingaben mit 32 Bit beschränkt. Andernfalls sind für einen Pixelshader bis zu 32 4-Komponenten-Eingaben von 32 Bit möglich.

Die Eingabedaten für Pixelshader umfassen Vertexattribute, die mit oder ohne perspektivische Korrekturen interpoliert oder als Pro-Grundtyp-Konstanten behandelt werden können. Pixelshader-Eingaben werden anhand der Vertexattribute des Grundtyps interpoliert und basierend auf dem angegebenen Interpolationsmodus gerastert. Wenn ein Grundtyp vor der Rasterung abgeschnitten wird, wird der Interpolationsmodus auch während des Zuschneidevorgangs berücksichtigt.
