...
## <a name="set-the-selection-mode-optional"></a><span data-ttu-id="00cb3-109">Festlegen des Auswahlmodus (optional)</span><span class="sxs-lookup"><span data-stu-id="00cb3-109">Set the selection mode (optional)</span></span>
