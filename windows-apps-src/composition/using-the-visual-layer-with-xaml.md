...
Weitere Informationen zum Verwenden von Pinseln mit XAML-UI finden Sie im Abschnitt [**Pinsel**](../graphics/using-brushes.md#xamlcompositionbrushbase).
...
Weitere Informationen zur Verwendung von Licht, einschließlich der Beleuchtung von XAML-UI-Elementen, finden Sie im Abschnitt [**Beleuchtung**](lighting.md).
...
Dies ist die [C++/CX](https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx)-Entsprechung des vorherigen C&#35;-Codes mit der gleichen XAML-Struktur.
