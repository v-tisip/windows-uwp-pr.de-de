...
Wie bereits erwähnt, ist InteractionTracker eine State-Machine mit 4 Zuständen, von denen jeder in einen der anderen vier Zustände übergehen kann. (Weitere Informationen darüber, wie InteractionTracker zwischen diesen Zuständen übergeht, finden Sie in der [InteractionTracker](https://docs.microsoft.com/uwp/api/windows.ui.composition.interactions.interactiontracker)-Klassendokumentation.)
