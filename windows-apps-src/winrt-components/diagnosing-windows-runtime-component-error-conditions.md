...
| WME1068      | Typ '{0}'nicht möglich den gleichen Namen wie der Namespace'{1}".                                                                                                                                                                                                                                                                                                 |
...
| Fehlernummer | Meldungstext |
|--------------|--------------|
| WME1091 | Die Methode ' \{0}' weist den Rückgabewert mit dem Namen ' \{1}"die entspricht dem Namen eines Parameters. Methodenparameter und Rückgabewerte müssen für Windows-Runtime eindeutige Namen aufweisen. |
