...
Eine Windows-Runtime-Enumeration in C++ / CX wird deklariert, mithilfe der öffentliche Klasse Enum; Es ähnelt eine Bereichsbezogene Enumeration in Standard-c++.
