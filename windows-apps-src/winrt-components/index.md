...
| Thema | Beschreibung |
|-------|-------------|
| [Erstellen von Komponenten für Windows-Runtime in C++](creating-windows-runtime-components-in-cpp.md) | Dieses Thema zeigt, wie Sie c++ / CX nach einer Windows-Runtime-Komponente erstellen, die ist eine Komponente, die von einer universellen Windows-app mit c#, Visual Basic, C++ oder Javascript erstellt aufgerufen werden kann. |
