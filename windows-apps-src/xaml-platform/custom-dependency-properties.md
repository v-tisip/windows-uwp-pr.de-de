...
> [!WARNING]
> Obwohl der Name, die Sie angeben, dass hier kann jeder Zeichenfolgebezeichner sein, die bei der Programmierung für die Sprache gültig ist, möchten Sie in der Regel Ihre Abhängigkeitseigenschaft auch in XAML festlegen können. Für die Verwendung in XAML muss der von Ihnen gewählte Eigenschaftenname ein gültiger XAML-Name sein. Weitere Informationen finden Sie in der [XAML-Übersicht](xaml-overview.md).
