...
-   *object* *property*: *object* *property* wird zusammen verwendet, wenn es sich bei der angezeigten Syntax um die Syntax für einen Typ handelt, der als Attributwert für viele Eigenschaften verwendet werden kann. So enthält z. B. die **XAML-Attributverwendung**, die für [**Brush**](/uwp/api/Windows.UI.Xaml.Media.Brush) angezeigt wird, Folgendes: <*object* *property*="*predefinedColorName*"/>
