...
<ul class="cardsF panelContent cols cols2">
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <a class="card" href="/windows/uwp/porting/apps-on-arm-x86-emulation" title="Thema ca. X86 Emulation" data-linktype="absolute-path">
                    <div class="cardImageOuter">
    ...
    <li>
        <a class="card" href="https://github.com/MicrosoftDocs/windows-uwp/tree/docs/landing/arm-docs" data-linktype="absolute-path">
            ...
            <div class="cardText">
                ...
                <p>Haben Sie ein Problem mit unsere Dokumentation gefunden? Möchten Sie uns etwas deutlicher zu erstellen? Erstellen Sie ein Problem auf unserer Dokumente GitHub-Repository.</p>
            </div>
        </a>
    </li>
</ul>